...
from briton.briton import BritonInteractor, BritonInteractorImpl, EosRespondingBritonInteractor, FailingBritonInteractor
...
class Model:
    ...
    def load(self):
        ...
        self._tokenizer = cast(
            ...
            self._briton_interactor.auto_tokenizer_from_pretrained(self._hf_tokenizer, self._hf_token)
        )
    ...
    def _start_monitor(self):
        # Overall, spec-dec model monitoring.
        monitor_settings = self._briton_interactor.monitor_settings()
        ...
        async def monitor_fn():
            try:
                return await test_predict(self.predict)
