...
class VectorStore:
    ...
    def load_collection(self, store_path: str) -> Dict[str, Any]:
        ...
        store["embeddings"] = np.load(os.path.join(store_path, "embeddings.npy"))
    ...
    def _create_and_save_index(
        ...
        np.save(os.path.join(store_path, "embeddings.npy"), data_embeddings)
        ...
        self.collections[collection_name] = {
            ...
            "category_index_mapping": category_index_mapping,
            "metadata_index_mapping": metadata_index_mapping,
            "embeddings": data_embeddings  # Save embeddings in memory as well
        }
