...
from metamart_source_mssql.models import Column, Edge, EdgeQuery, MsSqlNode, Table

ENV_PREFIX = "METAMART_MSSQL_"
...
class MsSqlMetamartSettings(BaseSettings):
    """ """

    namespace: str = "default"


class ConnectorSettings(MsSqlSettings, MsSqlMetamartSettings):
    """ """
