'''
 ...
 This file is generated form: gen/pyecoremdb.py.mako on 2024-06-01 19:36:51.300270 by calling E:\\1_ILS\\Projects\\2018_EOQ\\Groups\\PYEOQ\\pyeoq\\eoq3conceptsgen\\generatefromconceptscli.py -i gen/pyecoremdb.py.mako -o pyecoremdb.py -d gen/pyecoremdb.prev.json.
...
#         self.__PreventMetaMetaAccess(target,False)
    ...
    def _CreateM2OptionOfEnum(self, createArgs:LST, target:Obj, recoveryArgs:LST) -> Obj:
        ...
        nArgs = len(createArgs)
        if(nArgs!=3):
            raise EOQ_ERROR_INVALID_VALUE(CONCEPTS.M2OPTIONOFENUM+' createArgs require enum:Obj, name:STR and value:U64, but got %d arguments.'%(nArgs))
        #validate name
        self.__ValidateType(createArgs[0], STR, 'createArgs[0](name)')
        name = createArgs[0].GetVal()
        #validate name
