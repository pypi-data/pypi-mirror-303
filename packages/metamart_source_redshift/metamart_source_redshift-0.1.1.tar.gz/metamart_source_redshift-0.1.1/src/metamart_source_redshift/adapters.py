...
from metamart_source_redshift.models import (
    ID,
...
from metamart_source_redshift.package_definitions import config
...
@build_metamart_metadata.register
def build_metamart_metadata_from_column(current: LateBindingViewColumn, version: Literal["v1"] = "v1") -> ColumnMetadata:
    """
...
@build_metamart_metadata.register
def build_metamart_metadata_from_node(current: Table, version: Literal["v1"] = "v1") -> TableMetadata:
    """
