...
class tcetnlpfinal:
    ...
    def calculate_probabilities(ngrams_list, n):
        ...
        if n == 1:
            ...
            probabilities should be in curly braces 
    ...
    def laplace_smoothing(ngrams_list, n):
        ...
        if n == 1:
            ...
            curly braces here, probabilities is a dictionary
    ...
    sent should be in curly braces
        ...
        print("Extracted Named Entities:")
        for entity, entity_type in named_entities:
        entity and entity_type should be in curly braces
            print(f"Entity: entity, Type: entity_type")
