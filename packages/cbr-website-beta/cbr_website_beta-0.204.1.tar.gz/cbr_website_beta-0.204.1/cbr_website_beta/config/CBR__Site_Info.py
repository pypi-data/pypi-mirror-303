...
class CBR__Site_Info(Type_Safe):
    ...
    def dbs(self):
        db_cbr              = cbr_site_shared_objects.s3_cbr               ()
        db_chat_threads     = cbr_site_shared_objects.s3_db_chat_threads   ()
        db_server_requests  = cbr_site_shared_objects.s3_db_server_requests()
        db_servers          = cbr_site_shared_objects.s3_db_servers        ()
