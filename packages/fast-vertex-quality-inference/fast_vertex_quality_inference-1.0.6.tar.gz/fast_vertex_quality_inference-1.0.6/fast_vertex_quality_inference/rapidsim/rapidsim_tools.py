    ...
    with uproot.open(fileName) as f:
        ...
        if mass_hypotheses:
            for mass_hypothesis in mass_hypotheses:
                ...
                filtered_df = RAPIDSIM_particles_df[
            ...
            for particle in mass_hypotheses:
                if (
                    RAPIDSIM_particles_df[
                        (RAPIDSIM_particles_df["part"] == mass_hypotheses[particle])
                    ].shape[0]
                    == 1
                ):
                    pdg = int(
                    ...
                    RAPIDSIM_particles_df[
                        (RAPIDSIM_particles_df["anti"] == mass_hypotheses[particle])
                    ].shape[0]
                    == 1
                ):
                    pdg = int(
                    ...
                    display.error_splash(
                        post_message=f"{particle} not found in {RAPIDSIM_ROOT}/config/particles.dat, or listed multiple times."
                    )
                branches[f"{particle}_ID"] = (
