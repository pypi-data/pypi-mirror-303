...
SENSORS = [
    ...
    Sensor(name="CPU Average Load Over 1 minute", id="cpu_average1min", unit="%", measurement=True,
    ...
    Sensor(name="Network Input Errors", id="nework_errors_in", measurement=True,
