...
":param timestamp: Time stamp (may be 0 to indicate now)")
  ...
  .
def
("update", &wpi::log::StructArrayLogEntry<T, I>::Update,
      py::arg("data"), py::arg("timestamp") = 0, release_gil(), py::doc(
...
":param timestamp: Time stamp (may be 0 to indicate now)")
  ...
  .
def
("hasLastValue", &wpi::log::StructArrayLogEntry<T, I>::HasLastValue, release_gil(), py::doc(
...
":returns: True if last value exists, false otherwise.")
  ...
  .
def
("getLastValue", &wpi::log::StructArrayLogEntry<T, I>::GetLastValue, release_gil(), py::doc(
    "Gets the last value.\n"
"\n"
".. note:: The last value is local to this class instance and updated only with\n"
"   Update(), not Append().\n"
