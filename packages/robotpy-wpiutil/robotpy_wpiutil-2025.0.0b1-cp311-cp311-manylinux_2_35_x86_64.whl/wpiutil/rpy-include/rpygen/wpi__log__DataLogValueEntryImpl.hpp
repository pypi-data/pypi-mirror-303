...
void finish(const char * set_doc = NULL, const char * add_doc = NULL) {
  ...
  .
def
("hasLastValue", &wpi::log::DataLogValueEntryImpl<T>::HasLastValue, release_gil(), py::doc(
...
":returns: True if last value exists, false otherwise.")
  ...
  .
def
("getLastValue", &wpi::log::DataLogValueEntryImpl<T>::GetLastValue, release_gil(), py::doc(
    "Gets the last value.\n"
"\n"
".. note:: The last value is local to this class instance and updated only with\n"
"   Update(), not Append().\n"
