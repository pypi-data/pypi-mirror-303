...
from hugpi.model.api.types.tool_param import ToolParam
from hugpi.model.api.types._model_types import MODELS_TYPE
import logging
...
class HugpiChat(Model):
    ...
    def request_kwargs(self) -> Dict[str, Any]:
        kwargs = {"conversation": self.conversation,"debug":True}
        if self.tools:
