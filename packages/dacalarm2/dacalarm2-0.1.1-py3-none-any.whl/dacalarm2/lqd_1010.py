...
from dacalarm2.utils.control_delta import centered_ewm
from dacalarm2.utils.dac_facade import get_data, default_cache, mysql_conn
from dacalarm2.utils.ycl_abandon_abnormal import get_time, get_time_str, abandon_abnormal_ycl
...
def do(ycl_data, global_result):
    ...
    pre_guaidian20min_bw1r = round(
        bw1r_values[len(bw1r_values) - 41 - int((current_time - get_time(guaidian_time)).seconds / 30)], 2)
