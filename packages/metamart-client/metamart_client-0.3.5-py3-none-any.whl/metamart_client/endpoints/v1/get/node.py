...
from metamart_schemas.v1 import NodeV1, SourcedNodeV1, SourceV1
...
from metamart_client.endpoints.utilities import is_valid_uuid, validated_uuid
...
from metamart_client.schemas.labels import NodeLabels, SourceNodeLabels
...
@get.register
def get_node_v1(client: ClientV1, metamart_type: NodeV1, options: ClientOptions = ClientOptions()) -> NodeV1:
    """
...
@get.register
def get_from_node_spec(client: ClientV1, metamart_type: NodeSpec, options: ClientOptions = ClientOptions()) -> NodeV1:
    """
...
def get_source_node_by_label_v1(
    client: ClientV1,
    metamart_type: SourceNodeLabels,
    options: ClientOptions = ClientOptions(),
):
    """
