...
from metamart_schemas.base import Edge, Node, SourcedEdge, SourcedNode
from httpx import Auth, BasicAuth, QueryParams, Response
from multimethod import multimethod
from pydantic import BaseModel, SecretStr
from tqdm.autonotebook import tqdm

from metamart_client.authentication import APIKeyAuth
from metamart_client.endpoints.rest import delete, get, patch, post
from metamart_client.schemas.schema import MetamartType
...
ResultTypes = Union[Optional[MetamartType], Sequence[Optional[MetamartType]]]
...
class BaseClient(abc.ABC):
    ...
    @multimethod
    def get_url(self, metamart_type: Any) -> str:
        """
        ...
        """
        raise NotImplementedError(f"No url method implemented for type {type(metamart_type)}")
