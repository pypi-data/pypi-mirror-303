...
class _DicomSeries(metaclass=abc.ABCMeta):
  ...
  def get_credential_header(
    ...
    headers = {}
    crediental_source_hash = (
        self._dwi.credential_factory.credential_source_hash()
    )
    if (
        credential is None
