...
class DeniedVulnerabilityCriteria:
    cvss_severities: List[VulnerabilitySeverityLabels] = field(default_factory=list)
        ...
        installation = v3_0.Installation(
            ...
            deny=v3_0.DeniedInstallation(
                packages=v3_0.DeniedPackage(
                    warning_on_any_of=warn_packages, block_on_any_of=block_packages
                ),
                vulnerabilities=v3_0.DeniedVulnerability(
                    warning_on_any_of=warn_vulnerabilities,
                    block_on_any_of=block_vulnerabilities,
                ),
            ),
        )
