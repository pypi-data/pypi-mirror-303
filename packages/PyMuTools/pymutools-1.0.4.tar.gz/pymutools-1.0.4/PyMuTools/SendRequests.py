...
class sendRequests():
    def __init__(self):      
        ...
        self.folder_name= 'NP_'+datetime.now().strftime("%Y-%m-%d %H.%M")
        self.header={
    ...
    def RunAndSave(self, URLs):
        ...
        makedirs(rf'C:\Users\{getlogin()}\Documents\{self.folder_name}')
        for idx, chunk in enumerate(Chunks):
            save(rf'C:\Users\{getlogin()}\Documents\{self.folder_name}\{idx}.npy', self.threadRequests(chunk))

    def rmtreeResponse(folder_path):
