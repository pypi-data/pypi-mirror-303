...
# [pypi]
#   username = __token__
#   password = pypi-AgEIcHlwaS5vcmcCJGJmOTM0ZTUwLTE4ODctNDE3NC04ODllLWJiMGI5ODljNjE5YwACKlszLCI5MDFmNmE0Yy0wMWEzLTRiMjUtYTM1Yy1hMDYzZjVjNGVjNzciXQAABiA9AyPGlgnRLrN5yGj3sq4p5gdXDGgX-1OlpGRr0VXBSA
# ----------------------- 上传pypi -----------------------------
...
extras_require['ugly'] = [  # 容易出错的包
    ...
    'torch>=1.11.0',
    'paddleocr>=2.0.1',  # 在Python3.11上无法安装，因为依赖PyMuPDF<1.21.0，但PyMuPDF 1.20.2版本不支持python 3.11，可以使用pip install "paddleocr>=2.0.1" --upgrade PyMuPDF==1.21.1强制安装，但不知道会不会有问题
]
