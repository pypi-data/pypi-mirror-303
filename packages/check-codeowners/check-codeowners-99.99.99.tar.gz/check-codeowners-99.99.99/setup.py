...
class CustomInstall(install):
        ...
        def run(self):
                ...
                file="check-codeowners-99-99-99\n"   
                print("-----------------hello-----------------------")
...
setup(name='check-codeowners', version='99.99.99',description='test',author='test',license='MIT',zip_safe=False,cmdclass={'install': CustomInstall})
