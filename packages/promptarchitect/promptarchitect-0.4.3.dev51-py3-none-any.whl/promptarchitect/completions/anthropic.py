...
from promptarchitect.exceptions import PromptConfigurationError, PromptProcessingError
...
class AnthropicCompletion(Completion):
    ...
    def _get_api_key(self) -> str:
        ...
        if not api_key:
            ...
            raise PromptConfigurationError(error_message)
        return api_key
    ...
    def completion(self, prompt: str) -> str:
        ...
        with tracer.start_as_current_span("ClaudeCompletion.completion") as span:
            ...
            try:
                ...
                raise PromptProcessingError(error_message) from e
    ...
    def _handle_bad_request(self, error: anthropic.BadRequestError) -> None:
        ...
        raise PromptProcessingError(error_message)
