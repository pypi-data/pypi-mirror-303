...
def Leonardo_generate_image(model_name, prompt, height, width, payload="", number_images=1, image_file_path=None, strength=0.5, guidance_scale=7, photoReal=False, alchemy=False, contrastRatio=1, promptMagic=True, promptMagicStrength=0.4):
    ...
    # Create the payload
    if not payload:
        payload = create_payload(engine_model_id, prompt, height, width, number_images, image_id, strength, guidance_scale, photoReal, alchemy, contrastRatio, promptMagic, promptMagicStrength)
