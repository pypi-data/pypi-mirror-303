...
def airtable_fetch_filtered_rows(table_name, filter_formula="", fields=""):
    """
    ...
    try:
        ...
        # For example, you might want to extract specific fields or reformat the data
...
def main():
    ...
    fields=['Team']
    fields=""
    custom_response = airtable_fetch_filtered_rows(table_name=TABLE_NAME, filter_formula=filter_formula, fields=fields)
