    ...
    def run_nusmv(self):
        ...
        try:
            ...
            if "is true" in result.stdout:
                print(f"\033[1mFormalization process for the BehaviorTree {self.root_id} was successful.\033[0m")
            else:
                print(f"\033[1mFormalization process for the BehaviorTree {self.root_id} failed or returned false.\033[0m")
