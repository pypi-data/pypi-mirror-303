...
def main():  
    ...
    if hara_available:
        ...
        for item_id, hazard_dict in hara_generator.hara_dict.items():
            ...
            print(f"Hazard dictionary: {hazard_dict}")
    ...
    for fta in fta_list:
        ...
        # Attach the singular hazard detection nodes to the HARA behavior tree
            ...
            # Find the corresponding HARA behavior tree
            bt_hara = next((bt_hara for bt_hara in bt_hara_list if bt_hara.name == bt.name), None)
