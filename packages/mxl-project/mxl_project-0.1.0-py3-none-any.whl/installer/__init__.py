...
def help(args):
    if not args:
        print("Usage: mxl-python command [options]")
        print()
        print("Type 'mxl-python help <command>'", end="")
        ...
        if name not in _commands:
            ...
            print("Type 'mxl-python help' for usage.")
        else:
            details = _commands[name]
            print("Usage: mxl-python %s %s" % (name, details.options))
