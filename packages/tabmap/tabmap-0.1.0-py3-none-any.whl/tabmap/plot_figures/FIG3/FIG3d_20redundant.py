...
def generate_synthetic_data(n_samples, n_features, n_classes=2):
    ...
    features, labels = make_classification(
        ...
        n_redundant=n_features - int(0.8 * n_features),
        n_classes=n_classes,
...
for n_samples in n_samples_list:
    for n_features in n_features_list:
        ...
        save_to_dir = f'/home/yan/pyTabMap/code/plot_figures/FIG3/3d/simulated_data_20redundant/ns_{n_samples}_nf_{n_features}/data_raw.csv'
...
for n_samples in n_samples_list:
    for n_features in n_features_list:
        ...
        data_path='/home/yan/pyTabMap/code/plot_figures/FIG3/3d/simulated_data_20redundant'
        data_set=f'ns_{n_samples}_nf_{n_features}'
        results_path = '/home/yan/pyTabMap/code/plot_figures/FIG3/3d/simulated_data_20redundant'
        ...
        for fold_id, (train_idx_all, test_idx) in enumerate(skf.split(features, labels)):
            ...
            images_dict = {}
            runtime_dict = {}
            for model_id in ['tabmap', 'RF', 'GB', 'XGB']:
                print(f'\nTraining {model_id}')
