...
ConfigStateMachineConfigOutputMachineNextNodeCaseCondition: TypeAlias = Union[
...
class ConfigStateMachineConfigOutput(BaseModel):
    ...
    auto_aggregatator_config: Optional[
        ConfigStateMachineConfigOutputAutoAggregatatorConfig
    ] = None
...
Config: TypeAlias = Union[
    "PlanConfigOutput", "WorkflowConfigOutput", ConfigStateMachineConfigOutput
]
...
if PYDANTIC_V2:
    ...
    UserInput.update_forward_refs()  # type: ignore
