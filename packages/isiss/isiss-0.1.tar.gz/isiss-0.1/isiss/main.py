...
int main()
{
    ...
    for (int i = 0; i < word_count; i++)
    {
        ...
        for (int j = max_word_length - 1; j > 0; j--)
...
int main() {
    ...
    int message;
    cout << "Enter a numerical message to encrypt: ";
    cin >> message;

    if (message >= n) {
        cout << "Error: The message must be smaller than n." << endl;
        return 1;
    }
...
def main():
    ...
    match x:
            case 1:
                ...
                with open("Ceaser_Cipher.cpp", "w") as f:
