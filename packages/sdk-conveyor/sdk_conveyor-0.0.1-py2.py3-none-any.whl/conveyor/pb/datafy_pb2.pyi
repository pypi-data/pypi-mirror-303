...
class SparkSpec(_message.Message):
    __slots__ = ("image", "application", "application_args", "spark_config", "aws_role", "azure_application_client_id", "airflow_info", "datafy_project_info", "java_class", "env_vars", "env_variables", "mode", "aws_availability_zone", "scheduled_by", "driver_instance_type", "executor_instance_type", "executor_disk_size", "number_of_executors", "instance_life_cycle", "s3_committer", "verbose")
...
class SparkMetric(_message.Message):
    __slots__ = ("application_id", "project_id", "dag_id", "environment_id", "task_id", "build_id", "score", "duration", "executor_count", "efficiency", "cpu_efficiency", "unused_cpu_time_ms", "max_heap_memory_mb", "max_off_heap_memory_mb", "error_message", "started", "not_processed")
...
class ProcessSparkMetricsCommand(_message.Message):
    __slots__ = ("presigned_url", "tenant_id")
    PRESIGNED_URL_FIELD_NUMBER: _ClassVar[int]
    TENANT_ID_FIELD_NUMBER: _ClassVar[int]
    presigned_url: str
    tenant_id: str
    def __init__(self, presigned_url: _Optional[str] = ..., tenant_id: _Optional[str] = ...) -> None: ...
