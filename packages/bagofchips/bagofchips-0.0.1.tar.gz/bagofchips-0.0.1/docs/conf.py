...
copyright = "2024"
_repo_root_url = "https://git.ligo.org/james.kennington/chips"
...
def linkcode_resolve(domain, info) -> str:
    ...
    fn = os.path.relpath(fn, start=os.path.dirname(__import__("chips").__file__))
    ...
    return f"{_repo_root_url}/-/blob/main/src/chips/{fn}{lineno}"
