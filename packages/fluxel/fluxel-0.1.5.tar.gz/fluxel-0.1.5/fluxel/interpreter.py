...
def execute_wait(args):
    if not args:
        print("Error: Wait duration not specified.")
        return
    ...
    try:
        ...
        print(f"Error: Invalid wait duration '{args[0]}'. Please use a number.")

# In your main interpreter loop or command processing function:
if command == "wait":
    execute_wait(args)
