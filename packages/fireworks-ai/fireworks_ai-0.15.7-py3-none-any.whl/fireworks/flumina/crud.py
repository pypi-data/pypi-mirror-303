...
async def create_deployed_model(account_id: str, deployed_model_data: Dict[str, Any]) -> Dict[str, Any]:
...
async def delete_deployed_model(account_id: str, deployed_model_id: str) -> Dict[str, Any]:
