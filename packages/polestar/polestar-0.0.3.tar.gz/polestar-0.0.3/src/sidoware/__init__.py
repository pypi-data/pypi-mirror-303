...
#--------------------------------------------------------------------------------
# from .core import *
# from .polestar import *
# from .polestar import ProjectData, ConfigurationData, PackageData, ProjectManager, CommandManager


#--------------------------------------------------------------------------------
# 독립 모듈로 추가.
#--------------------------------------------------------------------------------
# sys.modules["polestar"] = sys.modules["sidoware.polestar"]
