...
class Application(Composite):
    ...
    def load_class_attributes(cls) -> None:
        """Initialize the public class attributes of the registered classes from
        their configuration files. Configuration files are automatically created
        with built-in default values, if not exists already.
        """
