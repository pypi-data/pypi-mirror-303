//Autogenerated PPP header from /panda/panda/plugins/syscalls2/generated/syscalls_ext_typedefs_mips64n32.h
...
typedef void (*on_sys_clone3_enter_t)(CPUState* cpu, target_ulong pc, uint32_t uargs, uint32_t size);
void ppp_add_cb_on_sys_clone3_enter(on_sys_clone3_enter_t);
bool ppp_remove_cb_on_sys_clone3_enter(on_sys_clone3_enter_t);
typedef void (*on_sys_clone3_return_t)(CPUState* cpu, target_ulong pc, uint32_t uargs, uint32_t size);
...
typedef void (*on_sys_newfstatat_enter_t)(CPUState* cpu, target_ulong pc, int32_t dfd, uint32_t filename, uint32_t statbuf, int32_t flag);
...
typedef void (*on_sys_newfstatat_return_t)(CPUState* cpu, target_ulong pc, int32_t dfd, uint32_t filename, uint32_t statbuf, int32_t flag);
...
bool ppp_remove_cb_on_sys_old_mmap_enter(on_sys_old_mmap_enter_t);
...
bool ppp_remove_cb_on_sys_old_mmap_return(on_sys_old_mmap_return_t);
typedef void (*on_sys_old_msgctl_enter_t)(CPUState* cpu, target_ulong pc, int32_t msqid, int32_t cmd, uint32_t buf);
void ppp_add_cb_on_sys_old_msgctl_enter(on_sys_old_msgctl_enter_t);
bool ppp_remove_cb_on_sys_old_msgctl_enter(on_sys_old_msgctl_enter_t);
typedef void (*on_sys_old_msgctl_return_t)(CPUState* cpu, target_ulong pc, int32_t msqid, int32_t cmd, uint32_t buf);
void ppp_add_cb_on_sys_old_msgctl_return(on_sys_old_msgctl_return_t);
bool ppp_remove_cb_on_sys_old_msgctl_return(on_sys_old_msgctl_return_t);
typedef void (*on_sys_old_semctl_enter_t)(CPUState* cpu, target_ulong pc, int32_t semid, int32_t semnum, int32_t cmd, uint32_t arg);
void ppp_add_cb_on_sys_old_semctl_enter(on_sys_old_semctl_enter_t);
bool ppp_remove_cb_on_sys_old_semctl_enter(on_sys_old_semctl_enter_t);
typedef void (*on_sys_old_semctl_return_t)(CPUState* cpu, target_ulong pc, int32_t semid, int32_t semnum, int32_t cmd, uint32_t arg);
void ppp_add_cb_on_sys_old_semctl_return(on_sys_old_semctl_return_t);
bool ppp_remove_cb_on_sys_old_semctl_return(on_sys_old_semctl_return_t);
typedef void (*on_sys_old_shmctl_enter_t)(CPUState* cpu, target_ulong pc, int32_t shmid, int32_t cmd, uint32_t buf);
void ppp_add_cb_on_sys_old_shmctl_enter(on_sys_old_shmctl_enter_t);
bool ppp_remove_cb_on_sys_old_shmctl_enter(on_sys_old_shmctl_enter_t);
typedef void (*on_sys_old_shmctl_return_t)(CPUState* cpu, target_ulong pc, int32_t shmid, int32_t cmd, uint32_t buf);
void ppp_add_cb_on_sys_old_shmctl_return(on_sys_old_shmctl_return_t);
bool ppp_remove_cb_on_sys_old_shmctl_return(on_sys_old_shmctl_return_t);
