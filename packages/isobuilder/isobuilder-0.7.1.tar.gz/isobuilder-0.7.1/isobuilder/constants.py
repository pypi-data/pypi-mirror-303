...
TXT_CFG = """label dnsops
  ...
  append  auto=true priority=critical initrd=/casper/initrd ramdisk_size=16384 root=/dev/ram keyboard-configuration/layoutcode=us console-setup/ask_detect=false rw console=ttyS1,115200n8 ---
label memtest
