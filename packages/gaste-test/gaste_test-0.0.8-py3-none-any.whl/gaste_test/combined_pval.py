...
def explicite_combination(
    ...
    Setting `verbose` to True will print additional information during the computation.
    ...
    >>> distribution = False
    >>> all_value = False
    >>> result = explicite_combinaison(list_params, list_pvals, type, tau, jobs, verbose, distribution, all_value)
    >>> print(result)
    0.0123456789
