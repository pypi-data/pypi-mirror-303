            ...
            try:
                ...
                if items:
                    ...
                    async with async_playwright() as p:
                        ...
                        validador_site = pyautogui.locateOnScreen(autorizacao_site, confidence=0.7)
                        ...
                        try:
                            while True:
                                solicitacao_senha = pyautogui.locateOnScreen(informar_senha_existe, confidence=0.7)
                                if solicitacao_senha:
                                    pyautogui.click(pyautogui.locateCenterOnScreen(cancelar, confidence=0.7))
                        ...
                        certificados_pje = pyautogui.locateOnScreen(certificados_disponiveis, confidence=0.7)
                        if certificados_pje:
