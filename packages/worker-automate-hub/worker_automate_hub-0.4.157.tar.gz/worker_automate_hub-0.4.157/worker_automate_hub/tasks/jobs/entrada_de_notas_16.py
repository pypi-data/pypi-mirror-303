...
async def entrada_de_notas_16(task: RpaProcessoEntradaDTO) -> RpaRetornoProcessoDTO:
    ...
    try:
        ...
        # Click Downloads
        await emsys.get_xml(nota.get("nfe"))
        ...
        console.print(f"Valor do checkbox: {checkbox.get_toggle_state()}", style="bold purple")
        ...
        if itens_by_supplier.get("IsOpened") == True:
        ...
        try:
            ...
            return {"sucesso": False, "retorno": f"Erro em obter o retorno de Nota inserida com sucesso, erro {e}"}
