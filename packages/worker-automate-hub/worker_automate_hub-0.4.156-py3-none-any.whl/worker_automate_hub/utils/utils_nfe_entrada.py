...
class EMSys:
    ...
    async def percorrer_grid(self):
        ...
        console.print(
            f"Trabalhando com os itens, alterando o código de tributação dos ISQUEIROS para manual \n"
        )
            ...
            while index_item_atual < index_ultimo_item:
                ...
                if "isqueiro" in item_value.lower():
                    ...
                    try:
                        ...
                        console.print(
                            f"Erro ao cancelar edição de item: {e}", style="bold green"
                        )
                    await worker_sleep(3)
    ...
    async def download_xml(
        self, google_drive_folder_id, get_gcp_token, get_gcp_credentials, chave_nota
    ):
