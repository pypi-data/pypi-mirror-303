...
def _uniffi_check_api_checksums(lib):
    ...
    if lib.uniffi_lwk_checksum_method_esploraclient_broadcast() != 54439:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_lwk_checksum_method_esploraclient_full_scan() != 17821:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_lwk_checksum_method_pset_inputs() != 59953:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_lwk_checksum_method_pset_issuance_asset() != 37868:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_lwk_checksum_method_pset_issuance_token() != 59034:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_lwk_checksum_method_txbuilder_drain_lbtc_wallet() != 46356:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_lwk_checksum_method_txbuilder_enable_ct_discount() != 16851:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_lwk_checksum_constructor_electrumclient_new() != 26281:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_lwk_checksum_constructor_esploraclient_new() != 7199:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_lwk_checksum_constructor_esploraclient_new_waterfalls() != 1829:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
...
_UniffiLib.uniffi_lwk_fn_method_txbuilder_enable_ct_discount.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_lwk_fn_method_txbuilder_enable_ct_discount.restype = None
...
_UniffiLib.uniffi_lwk_checksum_method_txbuilder_enable_ct_discount.argtypes = (
)
_UniffiLib.uniffi_lwk_checksum_method_txbuilder_enable_ct_discount.restype = ctypes.c_uint16
...
class EsploraClient:
    ...
    def __init__(self, url: "str"):
        ...
        self._pointer = _uniffi_rust_call(_UniffiLib.uniffi_lwk_fn_constructor_esploraclient_new,
    ...
    def new_waterfalls(cls, url: "str"):
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _uniffi_rust_call(_UniffiLib.uniffi_lwk_fn_constructor_esploraclient_new_waterfalls,
        _UniffiConverterString.lower(url))
        return cls._make_instance_(pointer)
...
class Network:
    ...
    def default_esplora_client(self, ) -> "EsploraClient":
        return _UniffiConverterTypeEsploraClient.lift(
            _uniffi_rust_call(_UniffiLib.uniffi_lwk_fn_method_network_default_esplora_client,self._uniffi_clone_pointer(),)
        )
...
class Pset:
    ...
    def issuance_asset(self, index: "int") -> "typing.Optional[AssetId]":
        ...
        return _UniffiConverterOptionalTypeAssetId.lift(
            _uniffi_rust_call(_UniffiLib.uniffi_lwk_fn_method_pset_issuance_asset,self._uniffi_clone_pointer(),
    ...
    def issuance_token(self, index: "int") -> "typing.Optional[AssetId]":
        ...
        return _UniffiConverterOptionalTypeAssetId.lift(
            _uniffi_rust_call(_UniffiLib.uniffi_lwk_fn_method_pset_issuance_token,self._uniffi_clone_pointer(),
        _UniffiConverterUInt32.lower(index))
        )
...
class TxBuilder:
    ...
    def enable_ct_discount(self, ) -> None:
        """
        Enable CT discount
        """

        _uniffi_rust_call_with_error(_UniffiConverterTypeLwkError,_UniffiLib.uniffi_lwk_fn_method_txbuilder_enable_ct_discount,self._uniffi_clone_pointer(),)
