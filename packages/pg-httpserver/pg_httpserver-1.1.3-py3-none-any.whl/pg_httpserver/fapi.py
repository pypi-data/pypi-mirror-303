...
if config.get_conf("needs_gzip_body", default=True):
    l = config.get_conf("gzip_body_length", default=1000)
    c = config.get_conf("gzip_compress_level", default=5)
...
if config.get_conf("needs_body_middleware", default=True):
