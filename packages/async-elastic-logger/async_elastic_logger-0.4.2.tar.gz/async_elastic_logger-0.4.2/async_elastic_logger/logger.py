...
class AsyncLogger:
    ...
    def log_sync(self, level: int, msg: Any) -> None:
        self.logger.log(level, msg)

    def info_sync(self, msg: Any) -> None:
        self.log_sync(logging.INFO, msg)

    def error_sync(self, msg: Any) -> None:
        self.log_sync(logging.ERROR, msg)

    def warning_sync(self, msg: Any) -> None:
        self.log_sync(logging.WARNING, msg)

    def debug_sync(self, msg: Any) -> None:
        self.log_sync(logging.DEBUG, msg)
