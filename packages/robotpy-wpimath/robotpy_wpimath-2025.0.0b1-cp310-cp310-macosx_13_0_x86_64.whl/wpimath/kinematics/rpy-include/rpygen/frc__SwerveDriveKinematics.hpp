...
":returns: The resulting Twist2d.")
  ...
  .
def
("toTwist2d", static_cast<Twist2d(frc::SwerveDriveKinematics<NumModules>::*)(const wpi::array<SwerveModulePosition, NumModules>&, const wpi::array<SwerveModulePosition, NumModules>&) const>(
        &frc::SwerveDriveKinematics<NumModules>::ToTwist2d),
...
"                                           reach while rotating")
  ...
  .
def
("interpolate", &frc::SwerveDriveKinematics<NumModules>::Interpolate,
  ...
  .
def
("getModules", &frc::SwerveDriveKinematics<NumModules>::GetModules, release_gil()
  )
