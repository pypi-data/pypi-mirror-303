...
// double dt = 5;
inline void ProtobufArmFeedforward::clear_dt() {
  _impl_.dt_ = 0;
}
inline double ProtobufArmFeedforward::_internal_dt() const {
  return _impl_.dt_;
}
inline double ProtobufArmFeedforward::dt() const {
  // @@protoc_insertion_point(field_get:wpi.proto.ProtobufArmFeedforward.dt)
  return _internal_dt();
}
inline void ProtobufArmFeedforward::_internal_set_dt(double value) {
  
  _impl_.dt_ = value;
}
inline void ProtobufArmFeedforward::set_dt(double value) {
  _internal_set_dt(value);
  // @@protoc_insertion_point(field_set:wpi.proto.ProtobufArmFeedforward.dt)
}
...
// double dt = 5;
inline void ProtobufElevatorFeedforward::clear_dt() {
  _impl_.dt_ = 0;
}
inline double ProtobufElevatorFeedforward::_internal_dt() const {
  return _impl_.dt_;
}
inline double ProtobufElevatorFeedforward::dt() const {
  // @@protoc_insertion_point(field_get:wpi.proto.ProtobufElevatorFeedforward.dt)
  return _internal_dt();
}
inline void ProtobufElevatorFeedforward::_internal_set_dt(double value) {
  
  _impl_.dt_ = value;
}
inline void ProtobufElevatorFeedforward::set_dt(double value) {
  _internal_set_dt(value);
  // @@protoc_insertion_point(field_set:wpi.proto.ProtobufElevatorFeedforward.dt)
}
...
// double dt = 4;
inline void ProtobufSimpleMotorFeedforward::clear_dt() {
  _impl_.dt_ = 0;
}
inline double ProtobufSimpleMotorFeedforward::_internal_dt() const {
  return _impl_.dt_;
}
inline double ProtobufSimpleMotorFeedforward::dt() const {
  // @@protoc_insertion_point(field_get:wpi.proto.ProtobufSimpleMotorFeedforward.dt)
  return _internal_dt();
}
inline void ProtobufSimpleMotorFeedforward::_internal_set_dt(double value) {
  
  _impl_.dt_ = value;
}
inline void ProtobufSimpleMotorFeedforward::set_dt(double value) {
  _internal_set_dt(value);
  // @@protoc_insertion_point(field_set:wpi.proto.ProtobufSimpleMotorFeedforward.dt)
}
