...
"permanent-magnet DC motor.";
  ...
  .def(py::init<units::volt_t, units::unit_t<kv_unit>, units::unit_t<ka_unit>, units::second_t>(),
      py::arg("kS"), py::arg("kV"), py::arg("kA") = units::unit_t<ka_unit> (0), py::arg("dt") = (units::second_t)20_ms, release_gil(), py::doc(
...
"           @throws IllegalArgumentException for period &le; zero.")
  ...
  .
def
("calculate", static_cast<units::volt_t(frc::SimpleMotorFeedforward<Distance>::*)(units::unit_t<Velocity>) const>(
...
":returns: The computed feedforward, in volts.")
  ...
  .
def
("calculate", static_cast<units::volt_t(frc::SimpleMotorFeedforward<Distance>::*)(units::unit_t<Velocity>, units::unit_t<Velocity>) const>(
        &frc::SimpleMotorFeedforward<Distance>::Calculate),
...
":returns: The minimum possible acceleration at the given velocity.")
  ...
  .
def
("getKs", &frc::SimpleMotorFeedforward<Distance>::GetKs, release_gil(), py::doc(
...
":returns: The static gain.")
  ...
  .
def
("getKv", &frc::SimpleMotorFeedforward<Distance>::GetKv, release_gil(), py::doc(
...
":returns: The velocity gain.")
  ...
  .
def
("getKa", &frc::SimpleMotorFeedforward<Distance>::GetKa, release_gil(), py::doc(
...
":returns: The acceleration gain.")
  ...
  .
def
("getDt", &frc::SimpleMotorFeedforward<Distance>::GetDt, release_gil(), py::doc(
    "Returns the period.\n"
"\n"
":returns: The period.")
  )
