...
":param time: The time at which to sample the buffer.")
  ...
  .
def
("getInternalBuffer", static_cast<std::vector<std::pair<units::second_t, T>>&(frc::TimeInterpolatableBuffer<T>::*)()>(
        &frc::TimeInterpolatableBuffer<T>::GetInternalBuffer), release_gil(), py::doc(
