...
class ProtobufRotation3d final :
 ...
 public:
  ...
  bool wpi_has_q() const;
  const ::wpi::proto::ProtobufQuaternion& wpi_q() const;
...
class ProtobufPose3d final :
 ...
 public:
  ...
  const ::wpi::proto::ProtobufTranslation3d& wpi_translation() const;
  // Custom WPILib Accessor
  bool wpi_has_rotation() const;
  const ::wpi::proto::ProtobufRotation3d& wpi_rotation() const;
