...
class ProtobufPose2d final :
 ...
 public:
  ...
  bool wpi_has_translation() const;
  const ::wpi::proto::ProtobufTranslation2d& wpi_translation() const;
  // Custom WPILib Accessor
  bool wpi_has_rotation() const;
  const ::wpi::proto::ProtobufRotation2d& wpi_rotation() const;
...
class ProtobufRectangle2d final :
 ...
 public:
  ...
  // Custom WPILib Accessor
  bool wpi_has_center() const;
  const ::wpi::proto::ProtobufPose2d& wpi_center() const;
