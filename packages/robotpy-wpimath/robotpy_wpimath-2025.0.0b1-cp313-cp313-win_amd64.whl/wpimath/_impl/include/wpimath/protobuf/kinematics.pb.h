...
class ProtobufMecanumDriveKinematics final :
 ...
 public:
  ...
  // Custom WPILib Accessor
  bool wpi_has_front_left() const;
  const ::wpi::proto::ProtobufTranslation2d& wpi_front_left() const;
  // Custom WPILib Accessor
  bool wpi_has_front_right() const;
  const ::wpi::proto::ProtobufTranslation2d& wpi_front_right() const;
  // Custom WPILib Accessor
  bool wpi_has_rear_left() const;
  const ::wpi::proto::ProtobufTranslation2d& wpi_rear_left() const;
  // Custom WPILib Accessor
  bool wpi_has_rear_right() const;
  const ::wpi::proto::ProtobufTranslation2d& wpi_rear_right() const;
...
class ProtobufSwerveModulePosition final :
 ...
 public:
  ...
  // Custom WPILib Accessor
  bool wpi_has_angle() const;
  const ::wpi::proto::ProtobufRotation2d& wpi_angle() const;
