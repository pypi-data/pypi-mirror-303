...
from al360_trustworthyai._internal.constants import (CausalManagerKeys,
                                               ListProperties, ManagerNames)
from al360_trustworthyai._tools.causal.causal_config import CausalConfig
from al360_trustworthyai._tools.causal.causal_constants import (DefaultParams,
                                                          ModelTypes)
from al360_trustworthyai._tools.causal.causal_result import CausalResult
...
class CausalManager(BaseManager):
    ...
    def add(
        ...
        validate_train_test_categories(
            ...
            al360_tai_compute_type='Causal analysis',
    ...
    def _fit_causal_analysis(
        ...
        try:
            ...
            clarification = (
                " Increase the value {} in al360_tai_insights.causal.add("
    ...
    def _load(path, al360_tai_insights):
        ...
        inst.__dict__['_target_column'] = al360_tai_insights.target_column
        ...
        inst.__dict__['_feature_metadata'] = al360_tai_insights._feature_metadata
