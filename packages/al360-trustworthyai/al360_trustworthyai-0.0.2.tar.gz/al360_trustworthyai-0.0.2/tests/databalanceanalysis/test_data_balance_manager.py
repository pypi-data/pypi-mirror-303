...
class TestDataBalanceManager:
    ...
    def test_save_and_load_basic(self, tmpdir, adult_data):
        ...
        loaded = saved._load(save_dir, al360_tai_insights)
        ...
        # All the instances variables from AL360_TAIInsights get set.
        ...
        # Also, df gets created using al360_tai_insights.train and al360_tai_insights.test
