...
from al360_trustworthyai import ModelAnalysis
...
def run_model_analysis(model, train_data, test_data, target_column,
    ...
    if model is None:
        ...
        with pytest.warns(DeprecationWarning,
                          match=("MODULE-DEPRECATION-WARNING: "
                                 "ModelAnalysis in al360_trustworthyai "
                                 "package is deprecated. "
                                 "Please use AL360_TAIInsights instead.")):
            model_analysis = ModelAnalysis(
                model, train_data, test_data,
                target_column,
                categorical_features=categorical_features,
    ...
    with TemporaryDirectory() as tempdir:
        path = Path(tempdir) / 'al360_tai_test_path'
...
def validate_model_analysis(
    ...
    if task_type == ModelTask.CLASSIFICATION:
        ...
        classes.sort()
        np.testing.assert_array_equal(model_analysis.al360_tai_insights._classes,
                                      classes)
