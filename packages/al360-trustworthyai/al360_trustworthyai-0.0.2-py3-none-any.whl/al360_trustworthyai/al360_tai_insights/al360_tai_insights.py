...
from al360_trustworthyai.al360_tai_insights.al360_tai_base_insights import AL360_TAIBaseInsights
...
class AL360_TAIInsights(AL360_TAIBaseInsights):
    ...
    def load(path):
        ...
        # load current state
        AL360_TAIBaseInsights._load(path, inst, manager_map,
