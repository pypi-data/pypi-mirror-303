...
from al360_trustworthyai._interfaces import CausalConfig as CausalConfigInterface
from al360_trustworthyai._interfaces import (CausalData, CausalPolicy,
                                       CausalPolicyGains,
...
from al360_trustworthyai._tools.causal.causal_constants import ResultAttributes
from al360_trustworthyai._tools.shared.base_result import BaseResult
from al360_trustworthyai._tools.shared.versions import CausalVersions
...
class CausalResult(BaseResult['CausalResult']):
    ...
    def _validate_version(cls, version):
        ...
        if semver_version.compare(CausalVersions.get_current()) > 0:
            raise ValueError("The installed version of al360_trustworthyai "
