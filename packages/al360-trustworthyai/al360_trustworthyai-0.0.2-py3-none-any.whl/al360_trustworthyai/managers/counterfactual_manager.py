...
from al360_trustworthyai._data_validations import validate_train_test_categories
from al360_trustworthyai._interfaces import CounterfactualData
from al360_trustworthyai._internal.constants import (CounterfactualManagerKeys,
...
class CounterfactualManager(BaseManager):
    ...
    def _add_counterfactual_config(self, new_counterfactual_config):
        ...
        validate_train_test_categories(
            ...
            al360_tai_compute_type='Counterfactual example generation',
    ...
    def _load(path, al360_tai_insights):
        ...
        inst.__dict__[CounterfactualManager._MODEL] = al360_tai_insights.model
        inst.__dict__[CounterfactualManager._TRAIN] = al360_tai_insights.train
        inst.__dict__[CounterfactualManager._TEST] = al360_tai_insights.test
        inst.__dict__[CounterfactualManager._TARGET_COLUMN] = \
            al360_tai_insights.target_column
        ...
        inst.__dict__[CounterfactualManager._CATEGORICAL_FEATURES] = \
            al360_tai_insights.categorical_features
