...
from pydantic_mongo_document.document.wrapper import wrap_insert
...
CIT = TypeVar("CIT", bound=Optional[Awaitable[None]])
...
IT = TypeVar("IT", bound=InsertOneResult | Awaitable[InsertOneResult])


class DocumentBase(BaseModel, ABC, Generic[CLT, DBT, COT, CIT, CT, DT, CCT, IT]):
