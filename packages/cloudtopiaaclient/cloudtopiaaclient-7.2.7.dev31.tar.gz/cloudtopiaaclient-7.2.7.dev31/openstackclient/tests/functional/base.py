    ...
    def openstack(
        ...
        *,
        ...
        :param cloud: The cloud to execute against. This can be a string, empty
            string, or None. A string results in '--ct-auth-type $cloud', an
            empty string results in the '--ct-auth-type' option being
            omitted, and None results in '--ct-auth-type none' for legacy
            reasons.
        ...
        if cloud is None:
            ...
            auth_args.append('--ct-auth-type none')
        elif cloud != '':
            # Execute command with an explicit cloud specified
            auth_args.append(f'--ct-cloud {cloud}')
