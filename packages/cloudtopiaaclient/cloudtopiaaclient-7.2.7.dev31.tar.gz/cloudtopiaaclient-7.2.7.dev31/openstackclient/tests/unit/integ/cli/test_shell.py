...
class TestIntegShellCliNoAuth(test_base.TestInteg):
    ...
    def test_shell_args_cacert(self):
        _shell = shell.OpenStackShell()
        _shell.run("--ct-cacert xyzpdq configuration show".split())
    ...
    def test_shell_args_cacert_insecure(self):
        _shell = shell.OpenStackShell()
        _shell.run("--ct-cacert xyzpdq --insecure configuration show".split())
...
class TestIntegShellCliV2(test_base.TestInteg):
    ...
    def test_shell_args_cacert(self):
        _shell = shell.OpenStackShell()
        _shell.run("--ct-cacert xyzpdq extension list".split())
    ...
    def test_shell_args_cacert_insecure(self):
        _shell = shell.OpenStackShell()
        _shell.run("--ct-cacert xyzpdq --insecure extension list".split())
...
class TestIntegShellCliPrecedence(test_base.TestInteg):
    ...
    * clouds.yaml
    ...
    def test_shell_args_options(self):
        ...
        _shell = shell.OpenStackShell()
        _shell.run(
            "--ct-username zarquon --ct-password qaz "
...
class TestIntegShellCliPrecedenceOCC(test_base.TestInteg):
    ...
    * clouds.yaml
    ...
    def test_shell_args_precedence_1(self, config_mock, vendor_mock):
        ...
        _shell = shell.OpenStackShell()
        _shell.run(
            "--ct-password qaz extension list".split(),
        )
    ...
    def test_shell_args_precedence_2(self, config_mock, vendor_mock):
        ...
        Run 2 has --ct-username, --ct-password, --ct-project-domain-id on CLI
        """
        ...
        _shell.run(
            "--ct-username zarquon --ct-password qaz "
            "--ct-project-domain-id 5678 extension list".split(),
        )
