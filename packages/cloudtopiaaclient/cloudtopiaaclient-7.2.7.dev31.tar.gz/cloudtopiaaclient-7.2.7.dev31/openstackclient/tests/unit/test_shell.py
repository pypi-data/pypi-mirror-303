...
global_options = {
    '--ct-cloud': (DEFAULT_CLOUD, True, True),
    '--ct-region-name': (DEFAULT_REGION_NAME, True, True),
    '--ct-default-domain': (DEFAULT_DOMAIN_NAME, True, True),
    '--ct-cacert': ('/dev/null', True, True),
    '--timing': (True, True, False),
    '--ct-profile': ('SECRET_KEY', True, False),
    '--ct-interface': (DEFAULT_INTERFACE, True, True),
}
...
class TestShellTokenAuthEnv(TestShell):
    ...
    def test_only_auth_url(self):
        flag = "--ct-auth-url http://cloud.local:555"
        kwargs = {
            "token": DEFAULT_TOKEN,
...
class TestShellTokenEndpointAuthEnv(TestShell):
    ...
    def test_only_url(self):
        flag = "--ct-endpoint http://cloud.local:555"
        kwargs = {
            "token": DEFAULT_TOKEN,
