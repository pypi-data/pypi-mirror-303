    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            ...
            help=_(
                ...
                '(supported by --ct-compute-api-version 2.49 or above)'
            ),
        )
        return parser
    ...
    def take_action(self, parsed_args):
        ...
        if parsed_args.tag:
            if not sdk_utils.supports_microversion(compute_client, '2.49'):
                msg = _(
                    '--ct-compute-api-version 2.49 or greater is required to '
...
class AddPort(command.Command):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            ...
            help=_(
                'Tag for the attached interface '
                '(supported by --ct-compute-api-version 2.49 or later)'
            ),
        )
        return parser
...
Specify ``--ct-compute-api-version 2.20`` or higher to add a volume to a server
    ...
    def get_parser(self, prog_name):
        ...
        termination_group.add_argument(
            ...
            help=_(
                ...
                '(supported by --ct-compute-api-version 2.79 or above)'
            ),
        )
        termination_group.add_argument(
    ...
    def take_action(self, parsed_args):
        ...
        if parsed_args.enable_delete_on_termination:
            if not sdk_utils.supports_microversion(compute_client, '2.79'):
                msg = _(
                    '--ct-compute-api-version 2.79 or greater is required to '
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            ...
            help=_(
                ...
                "server. "
                "For more advanced use cases, refer to the '--nic' parameter. "
                "(supported by --ct-compute-api-version 2.37 or above)"
            ),
        )
        parser.add_argument(
            '--auto-network',
        ...
        parser.add_argument(
            ...
            help=_(
                ...
                "(supported by --ct-compute-api-version 2.43 or above),\n"
        ...
        parser.add_argument(
            ...
            help=_(
                ...
                '(supported by --ct-compute-api-version 2.57 or below)'
            ),
        )
        parser.add_argument(
            '--user-data',
        ...
        parser.add_argument(
            ...
            help=_(
                ...
                '(supported by --ct-compute-api-version 2.19 or above)'
            ),
        )
        parser.add_argument(
            '--availability-zone',
        ...
        parser.add_argument(
            ...
            help=_(
                ...
                '(admin only) '
                '(supported by --ct-compute-api-version 2.74 or above)'
            ),
        )
        parser.add_argument(
            '--hypervisor-hostname',
        ...
        parser.add_argument(
            ...
            help=_(
                ...
                '(supported by --ct-compute-api-version 2.52 or above)'
            ),
        )
        parser.add_argument(
            '--hostname',
            ...
            help=_(
                ...
                '(supported by --ct-compute-api-version 2.90 or above)'
            ),
        )
        parser.add_argument(
            '--wait',
        ...
        parser.add_argument(
            ...
            help=_(
                ...
                '(supported by --ct-compute-api-version 2.63 or above)'
            ),
        )
        return parser
    ...
    def take_action(self, parsed_args):
        ...
        if parsed_args.file:
            if sdk_utils.supports_microversion(compute_client, '2.57'):
                msg = _(
                    ...
                    'for --ct-compute-api-version greater than 2.56; use '
                    'user data instead'
                )
                raise exceptions.CommandError(msg)
        ...
        if parsed_args.description:
            if not sdk_utils.supports_microversion(compute_client, '2.19'):
                msg = _(
                    '--ct-compute-api-version 2.19 or greater is '
        ...
        for mapping in parsed_args.block_devices:
            ...
            if 'tag' in mapping and (
                ...
                msg = _(
                    '--ct-compute-api-version 2.42 or greater is '
            ...
            if 'volume_type' in mapping and (
                ...
                msg = _(
                    '--ct-compute-api-version 2.67 or greater is '
        ...
        if 'auto' in parsed_args.nics or 'none' in parsed_args.nics:
            ...
            if not sdk_utils.supports_microversion(compute_client, '2.37'):
                msg = _(
                    '--ct-compute-api-version 2.37 or greater is '
            ...
            for nic in parsed_args.nics:
                if 'tag' in nic:
                    if not sdk_utils.supports_microversion(
                        ...
                        msg = _(
                            '--ct-compute-api-version 2.43 or greater is '
        ...
        if parsed_args.tags:
            if not sdk_utils.supports_microversion(compute_client, '2.52'):
                msg = _(
                    '--ct-compute-api-version 2.52 or greater is required to '
                    'support the --tag option'
                )
                raise exceptions.CommandError(msg)
        ...
        if parsed_args.host:
            if not sdk_utils.supports_microversion(compute_client, '2.74'):
                msg = _(
                    '--ct-compute-api-version 2.74 or greater is required to '
        ...
        if parsed_args.hostname:
            if not sdk_utils.supports_microversion(compute_client, '2.90'):
                msg = _(
                    '--ct-compute-api-version 2.90 or greater is required to '
        ...
        if parsed_args.trusted_image_certs:
            ...
            if not sdk_utils.supports_microversion(compute_client, '2.63'):
                msg = _(
                    '--ct-compute-api-version 2.63 or greater is required to '
...
class CreateServerDump(command.Command):
    ...
    This command requires ``--ct-compute-api-version`` 2.17 or greater.
    """
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            ...
            help=_(
                ...
                'when using ``--ct-compute-api-version`` 2.5 or greater.'
            ),
        )
        parser.add_argument(
            '--name',
        ...
        parser.add_argument(
            ...
            help=_(
                ...
                '(supported by --ct-compute-api-version 2.66 or above)'
            ),
        )
        parser.add_argument(
            '--changes-since',
        ...
        lock_group.add_argument(
            ...
            help=_(
                ...
                '(supported by --ct-compute-api-version 2.73 or above)'
            ),
        )
        lock_group.add_argument(
            '--unlocked',
        ...
        parser.add_argument(
            ...
            help=_(
                ...
                '(supported by --ct-compute-api-version 2.26 or above)'
            ),
        )
        parser.add_argument(
            '--not-tags',
    ...
    def take_action(self, parsed_args):
        ...
        if parsed_args.tags:
            if not sdk_utils.supports_microversion(compute_client, '2.26'):
                msg = _(
                    '--ct-compute-api-version 2.26 or greater is required to '
                    'support the --tag option'
                )
                raise exceptions.CommandError(msg)
        ...
        if parsed_args.locked:
            if not sdk_utils.supports_microversion(compute_client, '2.73'):
                msg = _(
                    '--ct-compute-api-version 2.73 or greater is required to '
        ...
        if search_opts['changes-before']:
            if not sdk_utils.supports_microversion(compute_client, '2.66'):
                msg = _('--ct-compute-api-version 2.66 or later is required')
                raise exceptions.CommandError(msg)
...
revert to release the new server and restart the old one."""
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            ...
            help=_(
                ...
                '(supported with --ct-compute-api-version 2.30 or above '
                'when used with the --live-migration option) '
                '(supported with --ct-compute-api-version 2.56 or above '
        ...
        migration_group.add_argument(
            ...
            help=_(
                ...
                '(default before --ct-compute-api-version 2.25, auto after)'
            ),
        )
        migration_group.add_argument(
            '--block-migration',
            ...
            help=_(
                ...
                '(auto-configured from --ct-compute-api-version 2.25)'
            ),
        )
        disk_group = parser.add_mutually_exclusive_group()
        disk_group.add_argument(
            ...
            help=_(
                ...
                '(supported with --ct-compute-api-version 2.24 or below)'
            ),
        )
        disk_group.add_argument(
            '--no-disk-overcommit',
    ...
    def take_action(self, parsed_args):
        ...
        if parsed_args.live_migration:
            ...
            # --ct-compute-api-version < 2.30 but that is the same thing
            ...
            if parsed_args.host and not sdk_utils.supports_microversion(
                ...
                raise exceptions.CommandError(
                    '--ct-compute-api-version 2.30 or greater is required '
                    'when using --host'
                )
            ...
            if not sdk_utils.supports_microversion(compute_client, '2.25'):
                ...
                msg = _(
                    ...
                    '--ct-compute-api-version 2.24 or below; this will '
            ...
            if parsed_args.host:
                if not sdk_utils.supports_microversion(compute_client, '2.56'):
                    msg = _(
                        '--ct-compute-api-version 2.56 or greater is '
...
class RebuildServer(command.ShowOne):
    ...
    def get_parser(self, prog_name):
        ...
        key_group.add_argument(
            ...
            help=_(
                ...
                '(supported by --ct-compute-api-version 2.54 or above)'
            ),
        )
        key_group.add_argument(
            '--no-key-name',
        ...
        user_data_group.add_argument(
            ...
            help=_(
                ...
                '(supported by --ct-compute-api-version 2.57 or above)'
            ),
        )
        user_data_group.add_argument(
            '--no-user-data',
        ...
        parser.add_argument(
            ...
            help=_(
                ...
                'Defaults to False. '
                '(supported by --ct-compute-api-version 2.93 or above)'
            ),
        )
        parser.add_argument(
    ...
    def take_action(self, parsed_args):
        ...
        if parsed_args.description:
            if not sdk_utils.supports_microversion(compute_client, '2.19'):
                msg = _(
                    '--ct-compute-api-version 2.19 or greater is required to '
        ...
        if parsed_args.key_name:
            if not sdk_utils.supports_microversion(compute_client, '2.54'):
                msg = _(
                    '--ct-compute-api-version 2.54 or greater is required to '
        ...
        if parsed_args.reimage_boot_volume:
            if not sdk_utils.supports_microversion(compute_client, '2.93'):
                msg = _(
                    '--ct-compute-api-version 2.93 or greater is required to '
            ...
            if not server.image or not server.image.id:
                if sdk_utils.supports_microversion(compute_client, '2.93'):
                    ...
                    self.log.warning(
                        ...
                        '--ct-compute-api-version 2.92 or earlier, which '
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            ...
            help=_(
                ...
                '(supported by --ct-compute-api-version 2.29 or above)'
            ),
        )
        ...
        shared_storage_group.add_argument(
            ...
            help=_(
                ...
                '--ct-compute-api-version 2.14 and greater and should not '
    ...
    def take_action(self, parsed_args):
        ...
        if parsed_args.host:
            if not sdk_utils.supports_microversion(compute_client, '2.29'):
                msg = _(
                    '--ct-compute-api-version 2.29 or later is required '
        ...
        if parsed_args.shared_storage:
            if sdk_utils.supports_microversion(compute_client, '2.14'):
                msg = _(
                    '--ct-compute-api-version 2.13 or earlier is required '
...
Specify ``--ct-compute-api-version 2.20`` or higher to remove a
...
Specify ``--ct-compute-api-version 2.87`` or higher to rescue a
...
Specify ``--ct-compute-api-version 2.47`` or higher to see the embedded flavor
    ...
    def get_parser(self, prog_name):
        ...
        diagnostics_group.add_argument(
            ...
            help=_(
                ...
                '(supported by --ct-compute-api-version 2.78 or above)'
            ),
        )
        return parser
    ...
    def take_action(self, parsed_args):
        ...
        if parsed_args.topology:
            if not sdk_utils.supports_microversion(compute_client, '2.78'):
                msg = _(
                    '--ct-compute-api-version 2.78 or greater is required to '
    ...
    def get_parser(self, prog_name):
        ...
        group.add_argument(
            ...
            help=_(
                ...
                '(supported by --ct-compute-api-version 2.77 or above)'
            ),
        )
        group.add_argument(
            ...
            help=_(
                ...
                '(supported by --ct-compute-api-version 2.91 or above)'
            ),
        )
        parser.add_argument(
            '--host',
    ...
    def take_action(self, parsed_args):
        ...
        if parsed_args.availability_zone:
            if not sdk_utils.supports_microversion(compute_client, '2.77'):
                msg = _(
                    '--ct-compute-api-version 2.77 or greater is required '
        ...
        if parsed_args.host:
            if not sdk_utils.supports_microversion(compute_client, '2.91'):
                msg = _(
                    '--ct-compute-api-version 2.91 or greater is required '
