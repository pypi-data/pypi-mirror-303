    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            ...
            help=_(
                ...
                "(supported with --ct-compute-api-version 2.59 or above)"
            ),
        )
        parser.add_argument(
            '--changes-before',
            ...
            help=_(
                ...
                "(supported with --ct-compute-api-version 2.66 or above)"
            ),
        )
        parser.add_argument(
            '--project',
            ...
            help=_(
                ...
                "(supported with --ct-compute-api-version 2.80 or above)"
            ),
        )
    ...
    def take_action(self, parsed_args):
        ...
        if parsed_args.marker:
            if not sdk_utils.supports_microversion(compute_client, "2.59"):
                msg = _(
                    '--ct-compute-api-version 2.59 or greater is required to '
        ...
        if parsed_args.changes_before:
            if not sdk_utils.supports_microversion(compute_client, "2.66"):
                msg = _(
                    '--ct-compute-api-version 2.66 or greater is required to '
        ...
        if parsed_args.project:
            if not sdk_utils.supports_microversion(compute_client, "2.80"):
                msg = _(
                    '--ct-compute-api-version 2.80 or greater is required to '
...
class ShowMigration(command.ShowOne):
    ...
    def take_action(self, parsed_args):
        ...
        if not sdk_utils.supports_microversion(compute_client, '2.24'):
            msg = _(
                '--ct-compute-api-version 2.24 or greater is required to '
...
class AbortMigration(command.Command):
    ...
    This command requires ``--ct-compute-api-version`` 2.24 or greater.
    """
...
class ForceCompleteMigration(command.Command):
    ...
    This command requires ``--ct-compute-api-version`` 2.22 or greater.
    """
    ...
    def take_action(self, parsed_args):
        ...
        if not sdk_utils.supports_microversion(compute_client, '2.22'):
            msg = _(
                '--ct-compute-api-version 2.22 or greater is required to '
