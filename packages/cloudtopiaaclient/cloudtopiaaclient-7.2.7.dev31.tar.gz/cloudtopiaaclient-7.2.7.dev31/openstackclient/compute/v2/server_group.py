    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            ...
            help=_(
                ...
                "Specify --ct-compute-api-version 2.15 or higher for the "
    ...
    def take_action(self, parsed_args):
        ...
        if parsed_args.policy in ('soft-affinity', 'soft-anti-affinity'):
            if not sdk_utils.supports_microversion(compute_client, '2.15'):
                msg = _(
                    '--ct-compute-api-version 2.15 or greater is required to '
        ...
        if parsed_args.rules:
            if not sdk_utils.supports_microversion(compute_client, '2.64'):
                msg = _(
                    '--ct-compute-api-version 2.64 or greater is required to '
