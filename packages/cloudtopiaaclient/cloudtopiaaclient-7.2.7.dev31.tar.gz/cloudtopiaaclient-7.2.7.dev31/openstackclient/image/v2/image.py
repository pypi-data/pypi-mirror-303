...
def _add_visibility_args(parser):
    ...
    public_group.add_argument(
        ...
        help=_(
            ...
            "(default until --ct-image-api-version 2.5)"
        ),
    )
    public_group.add_argument(
        "--community",
        ...
        help=_(
            ...
            "(requires --ct-image-api-version 2.5 or later)"
        ),
    )
    public_group.add_argument(
        "--shared",
        ...
        help=_(
            ...
            "(requires --ct-image-api-version 2.5 or later) "
            "(default since --ct-image-api-version 2.5)"
        ),
    )
    ...
    def _take_action_volume(self, parsed_args):
        ...
        if volume_client.api_version < api_versions.APIVersion('3.1'):
            if parsed_args.visibility or parsed_args.is_protected is not None:
                msg = _(
                    '--ct-volume-api-version 3.1 or greater is required '
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            ...
            help=_(
                ...
                '(requires --ct-image-api-version 2.15 or later)'
            ),
        )
        return parser
