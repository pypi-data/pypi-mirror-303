...
class CreateVolumeGroup(command.ShowOne):
    ...
    This command requires ``--ct-volume-api-version`` 3.13 or greater.
    """
    ...
    def get_parser(self, prog_name):
        ...
        source_parser.add_argument(
            ...
            help=_(
                ...
                '(supported by --ct-volume-api-version 3.14 or later)'
            ),
        )
        source_parser.add_argument(
            '--group-snapshot',
    ...
    def take_action(self, parsed_args):
        ...
        if volume_group_type:
            if volume_client.api_version < api_versions.APIVersion('3.13'):
                msg = _(
                    "--ct-volume-api-version 3.13 or greater is required to "
            ...
            if volume_client.api_version < api_versions.APIVersion('3.14'):
                msg = _(
                    "--ct-volume-api-version 3.14 or greater is required to "
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            ...
            help=_(
                ...
                '(supported by --ct-volume-api-version 3.38 or above)'
            ),
        )
        parser.add_argument(
            '--disable-replication',
    ...
    def take_action(self, parsed_args):
        ...
        if parsed_args.enable_replication is not None:
            if volume_client.api_version < api_versions.APIVersion('3.38'):
                msg = _(
                    "--ct-volume-api-version 3.38 or greater is required to "
...
class ListVolumeGroup(command.Lister):
    ...
    def get_parser(self, prog_name):
        ...
        #         "(supported by --ct-volume-api-version 3.33 or above)"
        #     ),
        # )
        return parser
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            ...
            help=_(
                ...
                '(supported by --ct-volume-api-version 3.25 or above)'
            ),
        )
        parser.add_argument(
            '--no-volumes',
    ...
    def take_action(self, parsed_args):
        ...
        if parsed_args.show_volumes is not None:
            if volume_client.api_version < api_versions.APIVersion('3.25'):
                msg = _(
                    "--ct-volume-api-version 3.25 or greater is required to "
...
class FailoverVolumeGroup(command.Command):
    ...
    This command requires ``--ct-volume-api-version`` 3.38 or greater.
    """
