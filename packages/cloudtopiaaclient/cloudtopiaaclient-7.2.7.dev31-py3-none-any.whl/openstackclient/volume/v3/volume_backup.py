    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            ...
            help=_(
                ...
                '(supported by --ct-volume-api-version 3.43 or above)'
            ),
        )
        parser.add_argument(
            '--availability-zone',
            ...
            help=_(
                ...
                '(supported by --ct-volume-api-version 3.51 or above)'
            ),
        )
        return parser
    ...
    def take_action(self, parsed_args):
        ...
        if parsed_args.properties:
            if not sdk_utils.supports_microversion(volume_client, '3.43'):
                msg = _(
                    '--ct-volume-api-version 3.43 or greater is required to '
        ...
        if parsed_args.availability_zone:
            if not sdk_utils.supports_microversion(volume_client, '3.51'):
                msg = _(
                    '--ct-volume-api-version 3.51 or greater is required to '
...
class SetVolumeBackup(command.Command):
    ...
    def get_parser(self, prog_name):
        ...
        parser.add_argument(
            ...
            help=_(
                'New backup name'
                '(supported by --ct-volume-api-version 3.9 or above)'
            ),
        )
        parser.add_argument(
            '--description',
    ...
    def take_action(self, parsed_args):
        ...
        if parsed_args.name:
            if volume_client.api_version < api_versions.APIVersion('3.9'):
                msg = _(
                    '--ct-volume-api-version 3.9 or greater is required to '
...
class UnsetVolumeBackup(command.Command):
    ...
    This command requires ``--ct-volume-api-version`` 3.43 or greater.
    """
