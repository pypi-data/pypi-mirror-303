...
class CreateVolume(volume_v2.CreateVolume):
    ...
    def get_parser(self, prog_name):
        ...
        source_group.add_argument(
            ...
            help=_(
                ...
                "(supported by --ct-volume-api-version 3.47 or later)"
            ),
        )
        source_group.add_argument(
            "--remote-source",
        ...
        parser.add_argument(
            ...
            help=_(
                ...
                "used along with the --remote-source option. "
                "(supported by --ct-volume-api-version 3.16 or above)"
            ),
        )
        return parser
    ...
    def take_action(self, parsed_args):
        ...
        if parsed_args.backup and not (
            ...
            msg = _(
                "--ct-volume-api-version 3.47 or greater is required "
        ...
        if parsed_args.remote_source:
            ...
            if parsed_args.cluster:
                if not sdk_utils.supports_microversion(
                    ...
                    msg = _(
                        "--ct-volume-api-version 3.16 or greater is required "
...
class VolumeSummary(command.ShowOne):
    ...
    def take_action(self, parsed_args):
        ...
        if not sdk_utils.supports_microversion(volume_client, '3.12'):
            msg = _(
                "--ct-volume-api-version 3.12 or greater is required to "
...
class VolumeRevertToSnapshot(command.Command):
    ...
    def take_action(self, parsed_args):
        ...
        if not sdk_utils.supports_microversion(volume_client, '3.40'):
            msg = _(
                "--ct-volume-api-version 3.40 or greater is required to "
