...
class BlockStorageManageVolumes(command.Lister):
    ...
    Supported by --ct-volume-api-version 3.8 or greater.
    """
    ...
    def get_parser(self, prog_name):
        ...
        host_group.add_argument(
            ...
            help=_(
                ...
                '(supported by --ct-volume-api-version 3.17 or later)'
            ),
        )
        parser.add_argument(
            '--long',
    ...
    def take_action(self, parsed_args):
        ...
        if volume_client.api_version < api_versions.APIVersion('3.8'):
            msg = _(
                "--ct-volume-api-version 3.8 or greater is required to "
        ...
        if parsed_args.cluster:
            if volume_client.api_version < api_versions.APIVersion('3.17'):
                msg = _(
                    "--ct-volume-api-version 3.17 or greater is required to "
