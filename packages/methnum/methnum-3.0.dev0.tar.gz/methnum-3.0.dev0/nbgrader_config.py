...
# server set up.
c.CourseDirectory.course_id = "MethNum"
...
c.CourseDirectory.ignore = ['.ipynb_checkpoints', '*.pyc', '__pycache__', 'core.*', '*~', '.*']
...
c.ClearSolutions.code_stub = {'python': '#LA REPONSE ICI'}
...
c.ClearSolutions.text_stub = 'LA REPONSE ICI (double-clique pour editer la cellule)'
