...
class PlacementFetcher:
  ...
  def get_already_excluded_placements(
    ...
    if preview_pagination_index_zero_based is not None:
      ...
      last_index = first_index + preview_pagination_size
      already_excluded_placements = gaarf.report.GaarfReport(
        results=already_excluded_placements.results[first_index:last_index],
        column_names=already_excluded_placements.column_names,
      )
