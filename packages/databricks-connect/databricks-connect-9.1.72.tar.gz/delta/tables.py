...
class DeltaTable(object):
    ...
    def restoreToVersion(self, version):
        ...
        Example::
            # to restore the table to version 1
        ...
        return self._jdt.restoreToVersion(version)

    def restoreToTimestamp(self, timestamp):
        """
        ...
        Example::
            # to restore the table to the version at timestamp of format (yyyy-MM-dd'T'HH:mm:ss)
        ...
        return self._jdt.restoreToTimestamp(timestamp)
