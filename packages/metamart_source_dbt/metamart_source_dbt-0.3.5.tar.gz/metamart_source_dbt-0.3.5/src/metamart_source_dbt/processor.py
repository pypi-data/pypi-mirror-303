...
from metamart_schemas.v1 import SourcedEdgeV1, SourcedNodeV1
from metamart_schemas.v1.source import SourceSpec

from metamart_source_dbt.adapters import adapt_to_client
from metamart_source_dbt.loaders import MANIFEST_MAP, AllDbtNodeTypes, ManifestTypes
from metamart_source_dbt.loaders.base import BaseManifestLoader
    ...
    def load(
        ...
        if version not in cls.MANIFEST_MAP and not strict_mode:
            ...
            warnings.warn(
                ...
                f"www.github.com/meta-mart/metamart-core/issues/new"
            )
