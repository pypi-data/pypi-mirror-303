...
async def chat_completions(
    ...
    is_pull = request_data.get("is_pull")

    if is_pull:
        all_events = [
            ChatEventItem(role="assistant", content="hello"),
        ]
        return ChatEventResponse(items=all_events)
...
async def chat_events(
    ...
    # all_events = [
    #     ChatEventItem(role="assistant", content="hello1"),
    #     ChatEventItem(role="assistant", content="hello2"),
    #     ChatEventItem(role="assistant", content="hello3"),
    # ]
    # return ChatEventResponse(items=all_events)
