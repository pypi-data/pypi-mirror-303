...
from mtmai.models.listview import ListViewesponse, ListviewItemPublic, ListviewRequest
...
@router.post("/", response_model=ListViewesponse)
async def listview_search(
    ...
    if dataType == "site":
        ...
        pass
    return ListViewesponse(count=count, items=conver_search_result_to_list_item(items))
