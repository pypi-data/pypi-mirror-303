...
test=True
if test:
    isoform_association_path = "/Users/saljh8/Dropbox/Revio/Young-Healthy-Revio/PacBio/test/gff-output/isoform_links.txt"

    gff_a72 = '/Users/saljh8/Dropbox/Revio/Aged-Healthy-Revio/PacBio/AM72/AM72.gff'
    ...
    gff_source = [gff_a72,gff_wm34,gencode_gff]
    ...
    pseudo_pdf, tpm, isoform_to_gene_ratio = iso.pseudo_cluster_counts(wm34_adata,cell_threshold=5,count_threshold=0,compute_tpm=True)
    pseudo_pdf.to_csv('WM34-combined_pseudo_cluster_counts.txt', sep='\t')
    tpm.to_csv('WM34-combined_pseudo_cluster-tpm.txt', sep='\t')
    isoform_to_gene_ratio.to_csv('WM34-combined_pseudo_cluster-ratio.txt', sep='\t')
    sys.exit()
...
if healthy_junction_counts:
    ...
    gff_bm71 = '/Users/saljh8/Dropbox/Revio/Aged-Healthy-Revio/PacBio/BF71/BF71.gff'
...
if build_pancancer_iso_ref:
    ...
    gff6 = '/Users/saljh8/Dropbox/Revio/Aged-Healthy-Revio/PacBio/AM72/AM72.gff'
    gff7 = '/Users/saljh8/Dropbox/Revio/Aged-Healthy-Revio/PacBio/WF83/WF83.gff'
    gff8 = '/Users/saljh8/Dropbox/Revio/Young-Healthy-Revio/PacBio/WM34/WM34.gff'
    gff9 = '/Users/saljh8/Dropbox/Revio/Young-Healthy-Revio/PacBio/BM27/BM27.gff'
    gff10 = '/Users/saljh8/Dropbox/Revio/Aged-Healthy-Revio/PacBio/BF71/BF71.gff'
    gff11 = '/Users/saljh8/Dropbox/Revio/Young-Healthy-Revio/PacBio/BF21/BF21.gff'
