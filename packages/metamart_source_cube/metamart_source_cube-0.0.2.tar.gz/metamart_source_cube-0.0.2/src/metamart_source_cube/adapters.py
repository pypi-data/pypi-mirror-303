...
from metamart_schemas.v1 import SourcedEdgeV1, SourcedNodeV1, SourceV1
from metamart_schemas.v1.generics import SQL, Code
...
from metamart_source_cube.package_definitions import config
...
def build_metamart_metadata_from_dimension(current: DimensionNode, version: Literal["v1"]) -> ColumnMetadata:
    """
...
@build_metamart_metadata.register
def build_metamart_metadata_from_measure(current: MeasureNode, version: Literal["v1"]) -> ColumnMetadata:
    """
...
@build_metamart_metadata.register
def build_metamart_metadata_from_node(current: Union[CubeNode, SourceNode], version: Literal["v1"]) -> TableMetadata:
    """
...
@build_metamart_metadata.register
def built_metamart_metadata_from_table_to_column_edge(current: CubeEdgeTableToColumn, version: Literal["v1"]):
    data = {
        "version": version,
        "tags": [config.metadata_id],
...
@build_metamart_metadata.register
def built_metamart_metadata_from_column_to_column_edge(current: CubeEdgeColumnToColumn, version: Literal["v1"]):
    data = {
        "version": version,
        "tags": [config.metadata_id],
        "edge_type": EdgeMetadataTypeLabels.table_to_column.value,
...
@build_metamart_metadata.register
def built_metamart_metadata_from_table_to_table_edge(current: CubeEdgeTableToTable, version: Literal["v1"]):
    data = {
        "version": version,
        "tags": [config.metadata_id],
