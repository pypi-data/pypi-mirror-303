...
import jwt
import requests
from metamart_schemas.v1.mock import MockSource
from metamart_source_cube.api import BaseCubeAPI, CubeSchema, MetamartSchema, MetaResponseSchema
from metamart_source_cube.base import CubeIntegration
...
class MetamartIDFactory(ModelFactory[MetamartID]):
    pass
...
class MetamartSchemaFactory(ModelFactory[MetamartSchema]):
    __set_as_default_factory_for_type__ = True


class CubeSchemaFactory(ModelFactory[CubeSchema]):
    __set_as_default_factory_for_type__ = True
    metamart_meta: MetamartSchema = MetamartSchemaFactory
