...
class OracleTools:
    ...
    def get_table_ddl_pg(dba_conn, username, table, forever_number_to_numeric=True):
        ...
        if metadata['comments'] != None:
            comments_str = ''
            comments_str = 'comment on table ' + username.lower() + '."' + table.lower() + '"' + " is E'" + metadata['comments'].replace('\\u', '\\\\u') + "'"
            sql_list.append(comments_str)
        ...
        for col in metadata['columns']:
            ...
            comments = col['comments']
            if comments != None: 
                comments_str = comments_str + 'comment on column ' + username.lower() + '."' + table.lower() + '"."' + name.lower() + '"' + " is E'" + comments.replace('\\u', '\\\\u') + "'"
                sql_list.append(comments_str)
        ...
        for constraint in metadata['constraints']:
            ...
            if type_ == 'primary_key':
                ...
                k_str = k_str + 'alter table ' + username.lower() + '."' + table.lower() + '" add foreign key (' + cols.lower() + ') references ' + username.lower() + '."' + r_table.lower() + '" (' + r_cols.lower() + ')'
            sql_list.append(k_str)
