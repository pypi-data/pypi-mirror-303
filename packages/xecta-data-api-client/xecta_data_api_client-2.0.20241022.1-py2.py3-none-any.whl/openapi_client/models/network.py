...
class Network(BaseModel):
    ...
    type: StrictStr = Field(description="Network type: PRODUCTION or INJECTION")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PRODUCTION', 'INJECTION']):
            raise ValueError("must be one of enum values ('PRODUCTION', 'INJECTION')")
        return value
