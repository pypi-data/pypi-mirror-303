...
class GasLiftValveInput(BaseModel):
    ...
    GasLiftValveInput
    """ # noqa: E501
    source_well_id: StrictStr = Field(description="SourceWellId of the well which owns the gas lift valve", alias="sourceWellId")
    source_wellbore_id: StrictStr = Field(description="SourceWellboreId of the wellbore which owns the gas lift valve", alias="sourceWellboreId")
    source_tubing_id: StrictStr = Field(description="SourceTubingId of the tubing in which the valve is installed", alias="sourceTubingId")
    source_id: StrictStr = Field(description="SourceId of the gas lift valve to enable upsert", alias="sourceId")
