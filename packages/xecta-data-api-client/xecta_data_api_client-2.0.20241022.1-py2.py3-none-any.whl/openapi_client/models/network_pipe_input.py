...
class NetworkPipeInput(BaseModel):
    ...
    NetworkPipeInput
    """ # noqa: E501
    source_network_id: StrictStr = Field(description="Source id of the network", alias="sourceNetworkId")
    source_id: StrictStr = Field(description="Source ID for the pipe definition", alias="sourceId")
