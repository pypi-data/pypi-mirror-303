...
class NetworkPipeConstraintInput(BaseModel):
    ...
    """ # noqa: E501
    source_network_id: StrictStr = Field(description="The Source ID for the network the constraint will belong to", alias="sourceNetworkId")
    source_pipe_id: StrictStr = Field(description="The Source ID for the network pipe that the constraint will belong to", alias="sourcePipeId")
    ...
    var_date: Optional[datetime] = Field(description="Date at which the constraint becomes applicable. Datetime offset (with timezone) in ISO 8601 format. Example: 2022-09-27T16:28:37+0000", alias="date")
