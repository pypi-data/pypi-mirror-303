...
class MicroStringInput(BaseModel):
    ...
    MicroStringInput
    """ # noqa: E501
    source_id: StrictStr = Field(description="SourceId of the micro string to enable upsert", alias="sourceId")
    source_wellbore_id: StrictStr = Field(description="SourceWellboreId of the wellbore which owns the micro string", alias="sourceWellboreId")
    source_well_id: StrictStr = Field(description="SourceWellId of the well which owns the micro string", alias="sourceWellId")
