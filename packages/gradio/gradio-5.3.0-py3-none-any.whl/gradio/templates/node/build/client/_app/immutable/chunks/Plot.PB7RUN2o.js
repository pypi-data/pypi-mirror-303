const __vite__fileDeps=["./PlotlyPlot.vFhYCdf_.js","./2.BtNuv8FW.js","./preload-helper.DpQnamwV.js","./stores.BtFSO3OC.js","./client.esIhOpOu.js","../assets/2.Dx44_cno.css","./BokehPlot.Dd2N6NIe.js","../assets/BokehPlot.DX04T7W4.css","./AltairPlot.Bo60mN6E.js","./color.CjarC7Qz.js","./vega-embed.module.e3xrRRPp.js","./dsv.CKxpOsHB.js","../assets/AltairPlot.O7q90H0e.css","./MatplotlibPlot.m3Jijthl.js","../assets/MatplotlibPlot.BHPTlvkw.css"],__vite__mapDeps=i=>i.map(i=>__vite__fileDeps[i]);
...
function create_if_block(ctx) {
  ...
  return {
    ...
    p(ctx2, dirty) {
      if (dirty & /*key*/
      1024 && safe_not_equal(previous_key, previous_key = /*key*/
      ctx2[10])) {
        group_outros();
...
function instance($$self, $$props, $$invalidate) {
  ...
  const plotTypeMapping = {
    plotly: () => __vitePreload(() => import("./PlotlyPlot.vFhYCdf_.js"), true ? __vite__mapDeps([0,1,2,3,4,5]) : void 0, import.meta.url),
    bokeh: () => __vitePreload(() => import("./BokehPlot.Dd2N6NIe.js"), true ? __vite__mapDeps([6,7]) : void 0, import.meta.url),
    altair: () => __vitePreload(() => import("./AltairPlot.Bo60mN6E.js"), true ? __vite__mapDeps([8,1,2,3,4,5,9,10,11,12]) : void 0, import.meta.url),
      ...
      if (value !== _value) {
        ...
        if (type && type in plotTypeMapping && is_browser) {
          if (loadedPlotTypeMapping[type]) {
            $$invalidate(9, PlotComponent = loadedPlotTypeMapping[type]);
          } else {
            plotTypeMapping[type]().then((module) => {
              $$invalidate(9, PlotComponent = module.default);
              $$invalidate(13, loadedPlotTypeMapping[type] = PlotComponent, loadedPlotTypeMapping);
            });
          }
        }
        $$invalidate(11, _value = value);
        $$invalidate(12, _type = type);
      }
    }
  };
  return [
