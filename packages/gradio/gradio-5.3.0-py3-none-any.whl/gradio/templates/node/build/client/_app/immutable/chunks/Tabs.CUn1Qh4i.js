import { SvelteComponent, init, safe_not_equal, svg_element, claim_svg_element, children, detach, attr, insert_hydration, append_hydration, noop, create_slot, space, claim_space, listen, transition_in, group_outros, transition_out, check_outros, update_slot_base, get_all_dirty_from_scope, get_slot_changes, run_all, component_subscribe, createEventDispatcher, onMount, setContext, set_store_value, ensure_array_like, element, create_component, claim_element, claim_component, toggle_class, mount_component, stop_propagation, update_keyed_each, destroy_block, destroy_component, destroy_each, empty, text, claim_text, set_data, binding_callbacks, tick } from "../../../svelte/svelte.js";
...
function create_if_block(ctx) {
  ...
  return {
    ...
    h() {
      attr(div0, "class", "tab-container visually-hidden svelte-ct9gpx");
      attr(div0, "aria-hidden", "true");
      attr(div1, "class", "tab-container svelte-ct9gpx");
      attr(div1, "role", "tablist");
      attr(button, "class", "svelte-ct9gpx");
      toggle_class(
        button,
      ...
      attr(div2, "class", "overflow-dropdown svelte-ct9gpx");
      toggle_class(div2, "hide", !/*overflow_menu_open*/
      ctx[9]);
      attr(span, "class", "overflow-menu svelte-ct9gpx");
      toggle_class(span, "hide", !/*is_overflowing*/
      ctx[11]);
      attr(div3, "class", "tab-wrapper svelte-ct9gpx");
      attr(div4, "class", div4_class_value = "tabs " + /*elem_classes*/
      ctx[2].join(" ") + " svelte-ct9gpx");
      attr(
        div4,
        "id",
        /*elem_id*/
    ...
    p(ctx2, dirty) {
      ...
      4 && div4_class_value !== (div4_class_value = "tabs " + /*elem_classes*/
      ctx2[2].join(" ") + " svelte-ct9gpx")) {
