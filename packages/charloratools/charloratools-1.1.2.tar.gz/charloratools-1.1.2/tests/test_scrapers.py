...
def test_vsco_scraper_success(mock_webdriver: MagicMock) -> None:
    """
    Simulates sucessfully scraping VSCO images with unittest's MagicMock

    Parameters
    ----------
    mock_webdriver : MagicMock
        The MagicMock instance returned by the pytest fixture.
    """
...
def test_vsco_scraper_login_failure(mock_webdriver: MagicMock) -> None:
    """
    Simulates a sign-in error while
    scraping VSCO images with unittest's MagicMock
...
def test_vsco_no_images_found(mock_webdriver: MagicMock) -> None:
    """
    Simulates the scenario in which no images are found in the user's
    profile while scraping VSCO images with unittest's MagicMock.
...
def test_xscraper_success(mock_webdriver: MagicMock) -> None:
    """
    Simulates sucessfully scraping X profile images with unittest's MagicMock
...
def test_xscraper_login_failure(mock_webdriver: MagicMock) -> None:
    """
    Simulates a login error while scraping X
    profile images with unittest's MagicMock.
...
def test_xscraper_no_images_found(mock_webdriver: MagicMock) -> None:
    """
    Simulates not finding any media in the user's profile when
    scraping X images with unittest's MagicMock.
...
def test_instagram_scraper_success(mock_webdriver: MagicMock) -> None:
    """
    Simulates sucessfully scraping an user's
...
def test_instagram_scraper_login_failure(mock_webdriver: MagicMock) -> None:
    """
    Simulates a sign-in error when trying to scrape
    instagram feed pictures.
...
def test_instagram_scraper_no_images_found(mock_webdriver: MagicMock) -> None:
    """
    Simulates trying to scrape instagram feed pictures of
    a profile with no pictures.
