...
errors.NoFaceDetectedInReferenceImage
...
class FaceRecognizer:
    ...
    def __str__(self) -> str:
        ...
        """
        p = f"Path:{self.path};"
        i = f"Images:{len(self.gallery)};"
        d = f"Torch Device:{self.device};"
        return f"FaceRecognizer[{p} {i} {d}]"
    ...
    def change_directory(self, path: str | Path) -> None:
        """
    ...
    def filter_images_without_face(self,
                                   output_dir: str | Path,
                                   min_face_size: int = 20,
                                   prob_threshold: float | None = None,
                                   return_info: bool = False
                                   ) -> SysFileManager.GalleryManager | tuple:
        """
        ...
        """
        # Check dir
        output_dir = utils.dirisvalid(path=output_dir,
