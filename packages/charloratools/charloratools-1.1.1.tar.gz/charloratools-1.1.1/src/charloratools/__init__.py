...
datasets used for Stable Diffusion LoRa training
(hence the name), **it leverages
[`facenet_pytorch`](https://github.com/timesler/facenet-pytorch)'s
implementation of advanced face detection and recognition ML models
`(MTCNN and InceptionResnetv1)` and
[`ImageHash`](https://github.com/JohannesBuchner/imagehash)'s implementation
of robust hashing algorithms for image files to provide useful and accurate
means of handling diverse image datasets.**
