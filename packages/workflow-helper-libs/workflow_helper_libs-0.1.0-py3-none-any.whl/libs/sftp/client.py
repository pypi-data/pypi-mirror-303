...
class SftpClient:
    ...
    def __init__(
        self, host: str, known_host: str, username: str, private_key: str, rsa_pkey: str, port: int = 22
    ) -> None:
    ...
    def write_csv_file(self, header: tuple, data: list, target_filename: str, upload_dir: str = None):
        """
