...
from bigquery_sync.app.config.config import SCHEDULED_QUERIES, SCHEDULED_QUERY_TOPIC_PUBSUB
...
class ScheduledQueryManager(object):
    ...
    def __init__(self, project, project_root_path, service_account_file_path, git_manager: GitManager):
        ...
        self.pubsub_topic = self.pubsub_client.get_pubsub_topic(project, SCHEDULED_QUERY_TOPIC_PUBSUB)
    ...
    def __update_config(self, transfer_config, configuration, query):
        ...
        if configuration['notification_pubsub_topic']:
            ...
            transfer_config.notification_pubsub_topic = self.pubsub_client.client.topic_path(self.project, configuration[
