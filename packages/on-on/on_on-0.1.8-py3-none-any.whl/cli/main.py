...
def main(new: Annotated[Optional[str], Argument(help="Yeni bir depo oluşturmak için depo adını belirtiniz.")] = None, token: Annotated[Optional[str], Option(help="Özel bir token belirtiniz.")] = None):
    if new is not None:
