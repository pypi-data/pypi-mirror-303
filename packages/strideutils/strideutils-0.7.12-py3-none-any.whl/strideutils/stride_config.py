...
class Environment:
    ...
    UPSTASH_STRIDE_DYDX_PUBLIC_HOST = "UPSTASH_STRIDE_DYDX_PUBLIC_HOST"
    UPSTASH_STRIDE_DYDX_PUBLIC_PORT = "UPSTASH_STRIDE_DYDX_PUBLIC_PORT"
    UPSTASH_STRIDE_DYDX_PUBLIC_PASSWORD = "UPSTASH_STRIDE_DYDX_PUBLIC_PASSWORD"
