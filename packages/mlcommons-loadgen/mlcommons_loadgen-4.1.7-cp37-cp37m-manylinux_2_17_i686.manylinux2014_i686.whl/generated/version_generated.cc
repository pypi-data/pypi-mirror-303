...
const std::string& LoadgenBuildDateLocal() {
  static const std::string str = "2024-10-22T10:10:24.395992";
  return str;
}

const std::string& LoadgenBuildDateUtc() {
  static const std::string str = "2024-10-22T10:10:24.395998";
  return str;
}

const std::string& LoadgenGitRevision() {
  static const std::string str = "35b25d9c05";
  return str;
}

const std::string& LoadgenGitCommitDate() {
  static const std::string str = "2024-10-22T10:04:44Z";
  return str;
}
...
const std::string& LoadgenGitLog() {
  static const std::string str = R"LGVG_RSLD(35b25d9c0504b58f1e8a06b09cfe0ca8ac737189 Increment version to 4.1.7
db927c3afce45a74b90b21dd1e4d4aabb99eb3e8 Update VERSION.txt)LGVG_RSLD";
  return str;
}
...
cb67dcc41adcbb7849a0a808a501ee9ccd951d92 /VERSION.txt
