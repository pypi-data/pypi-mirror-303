...
const std::string& LoadgenBuildDateLocal() {
  static const std::string str = "2024-10-21T23:36:56.164240";
  return str;
}

const std::string& LoadgenBuildDateUtc() {
  static const std::string str = "2024-10-21T23:36:56.164256";
  return str;
}

const std::string& LoadgenGitRevision() {
  static const std::string str = "013750d064";
  return str;
}

const std::string& LoadgenGitCommitDate() {
  static const std::string str = "2024-10-21T23:23:31Z";
  return str;
}
...
const std::string& LoadgenGitLog() {
  static const std::string str = R"LGVG_RSLD(013750d0644dee11a573f1abc92a768216e8a803 Increment version to 0.0.1
15e5f4089af8e89eeb97ffbe0a3e5f8d75b66a70 VERSION -> VERSION.txt)LGVG_RSLD";
  return str;
}
...
b9d640af1087eb911d0d1995a3badcba5d44b193 /VERSION.txt
