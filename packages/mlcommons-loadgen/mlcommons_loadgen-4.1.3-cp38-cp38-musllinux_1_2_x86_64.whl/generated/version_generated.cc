...
const std::string& LoadgenBuildDateLocal() {
  static const std::string str = "2024-10-21T23:18:04.668162";
  return str;
}

const std::string& LoadgenBuildDateUtc() {
  static const std::string str = "2024-10-21T23:18:04.668168";
  return str;
}

const std::string& LoadgenGitRevision() {
  static const std::string str = "9469636859";
  return str;
}

const std::string& LoadgenGitCommitDate() {
  static const std::string str = "2024-10-21T23:07:59Z";
  return str;
}
...
const std::string& LoadgenGitLog() {
  static const std::string str = R"LGVG_RSLD(9469636859d8d6ec2ab5502d5204ee4bbd56d64f Increment version to 4.1.3
7dd5c8338319be30947ad10a26b8ca344e3d2dac Update VERSION)LGVG_RSLD";
  return str;
}
...
59f3c7ac8f33a7695494f8a9a1045fee83eda2bc /CMakeLists.txt
d32664ae990107de038046cc4565eddf340147f3 /MANIFEST.in
...
5a78d1e5d6c7383acad5ff16952df1d039d0bb57 /VERSION
...
67e99e13048f9100836c56c10a463b4e03c7fa29 /setup.py
