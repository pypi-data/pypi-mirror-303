...
const std::string& LoadgenBuildDateLocal() {
  static const std::string str = "2024-10-22T08:22:43.204182";
  return str;
}

const std::string& LoadgenBuildDateUtc() {
  static const std::string str = "2024-10-22T08:22:43.204198";
  return str;
}

const std::string& LoadgenGitRevision() {
  static const std::string str = "da1000fd72";
  return str;
}

const std::string& LoadgenGitCommitDate() {
  static const std::string str = "2024-10-22T08:21:24Z";
  return str;
}
...
const std::string& LoadgenGitLog() {
  static const std::string str = R"LGVG_RSLD(da1000fd721ef183988a02393cf99ec1774dfcda Increment version to 4.1.4
7e2273010bea4438a972fe83e1ade74d9ff1f6ca Fixes for github action)LGVG_RSLD";
  return str;
}
...
b73434348f7860471606aaa395b570e81113cb6d /CMakeLists.txt
...
05f0389a096ddf209f93c266bfebc26c14338f15 /VERSION.txt
...
0437c360fc525d595ce0846fb6566be4f6553a76 /pyproject.toml
