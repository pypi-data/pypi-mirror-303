...
class MessageRequest(BaseModel):
    ...
    context: Optional[ChattyContext] = Field(default_factory=lambda: ChattyContext.default())
    subtype: Optional[MessageSubtype] = Field(default=lambda: MessageSubtype.NONE)
