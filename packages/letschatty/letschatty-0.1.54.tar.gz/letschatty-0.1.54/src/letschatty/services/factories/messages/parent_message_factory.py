...
from ....models.messages.chatty_messages import ChattyResponse
...
def from_message_request(message_request : MessageRequest) -> ChattyMessage:
    return MessagefromMessageRequestFactory.from_request(message_request)
