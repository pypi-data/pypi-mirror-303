...
("setInput", static_cast<void(frc::sim::LinearSystemSim<States, Inputs, Outputs>::*)(int, double)>(
        &frc::sim::LinearSystemSim<States, Inputs, Outputs>::SetInput),
      py::arg("row"), py::arg("value"), release_gil(), py::doc(
...
":param value: The value to set the row to.")
  ...
  .
def
("getInput", static_cast<const Vectord<Inputs>&(frc::sim::LinearSystemSim<States, Inputs, Outputs>::*)() const>(
        &frc::sim::LinearSystemSim<States, Inputs, Outputs>::GetInput), release_gil(), py::doc(
...
":returns: The current input of the plant.")
  ...
  .
def
("getInput", static_cast<double(frc::sim::LinearSystemSim<States, Inputs, Outputs>::*)(int) const>(
        &frc::sim::LinearSystemSim<States, Inputs, Outputs>::GetInput),
      py::arg("row"), release_gil(), py::doc(
...
":param dt:          The time difference between controller updates.")
  ...
  .
def
("_clampInput", static_cast<void(frc::sim::LinearSystemSim<States, Inputs, Outputs>::*)(double)>(&LinearSystemSim_Trampoline::ClampInput),
      py::arg("maxInput"), release_gil(), py::doc(
