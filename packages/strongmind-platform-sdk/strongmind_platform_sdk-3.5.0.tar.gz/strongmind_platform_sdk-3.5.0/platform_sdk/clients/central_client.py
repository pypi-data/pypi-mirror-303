...
from clients.identity_client import IdentityServerClient
from helpers.exception_logger import raise_for_status_with_dependency_name
from shared.constants import STRONGMIND_CENTRAL
...
class CentralClient:
    ...
    def post_guardians(self, user_uid: str, guardians: list):
        ...
        self._post_data(self.build_guardian_payload(guardians), f"users/{user_uid}/guardians")
