...
class Connection:
    ...
    def getlocalsql(self, resource_name, sql_name):
        """
        获取sql文件
        """
        self.upload(resource_name, 'D:/javaEnv/vagrant_bigdata_cluster/resources/bdcompetition/sql/{}.sql'.format(sql_name), '/root/{}.sql'.format(sql_name))
        print("upload sql success！")
