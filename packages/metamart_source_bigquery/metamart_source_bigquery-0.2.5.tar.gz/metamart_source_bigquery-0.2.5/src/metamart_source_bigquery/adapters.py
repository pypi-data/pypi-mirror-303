...
from metamart_source_bigquery.models import (
    ID,
    Column,
    ColumnID,
    Constraint,
...
from metamart_source_bigquery.package_definitions import config
...
@multimethod
def build_metamart_metadata(current: Any, desired: Any) -> BaseModel:
    """
