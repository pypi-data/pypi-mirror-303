...
from metamart_source_openlineage.models import Column, Edge, NodeTypes, Table
from metamart_source_openlineage.package_definitions import config
...
@build_metamart_metadata.register
def build_metamart_metadata_from_edge(current: Edge, version: Literal["v1"] = "v1") -> EdgeReturnTypes:
    """
