...
def test_ical_ordering_produces_reasonable_reports(patterns):
...
def test_ical_with_multiple_patterns(patterns):
...
def test_fc_qemu_output_unclear_reason_why_missing_matches(patterns):
