...
class ValidationHelper(IValidation):
    ...
    def __init__(self, model_path=None, model_info=None):
        ...
        self.end = outsample_end_date(datetime.now(), n_week=FREQ_TO_VALIDATION_WEEK_RANGE[model_info["freq"]])
    ...
    def validate_combine_getter(self, end):
        try:
            ...
            start_date = self.days_before(end, 90, self.exchange)
