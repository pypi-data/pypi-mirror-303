...
from metamart_cli.api.demo.setup import demo_app
from metamart_cli.utilities.styling import print


class Demo:
    default_url = "https://raw.githubusercontent.com/meta-mart/metamart-core/master/examples/deployment/docker-compose/demo/docker-compose.yaml"
