...
import typer
from metamart_client.schemas.schema import validate_file
from metamart_schemas.utilities import merge
from typing_extensions import Annotated

from metamart_cli.api.callbacks import requires_config_decorator
from metamart_cli.api.entrypoint import app
from metamart_cli.api.server.setup import client_app, client_get_app, get_default_client
from metamart_cli.utilities import utilities
from metamart_cli.utilities.styling import default_styler
from metamart_cli.utilities.styling import print as print_styled
from metamart_cli.utilities.utilities import write_yaml
...
def get_nodes_cli(
    ...
    * metamart get nodes --is_active True --name my_node
    * metamart get nodes --metadata__metamart__node_type Table
