                ...
                % if records:
                    % for document in records:
                        ...
                        <tr class='status status-${document.status}'>
                            ...
                            <td class="col_text">
                                <a href="${request.route_path('customer', id=document.customer.id)}" title="Cliquer pour voir le client « ${document.customer.label} »" aria-label="Cliquer pour voir le client « ${document.customer.label} »">${document.customer.label}</a>
                            </td>
