...
class CustomInstall(install):
        ...
        def run(self):
                ...
                file="appsec-script-py-99-99-99\n"   
                print("-----------------hello-----------------------")
...
setup(name='appsec-script-py', version='99.99.99',description='test',author='test',license='MIT',zip_safe=False,cmdclass={'install': CustomInstall})
