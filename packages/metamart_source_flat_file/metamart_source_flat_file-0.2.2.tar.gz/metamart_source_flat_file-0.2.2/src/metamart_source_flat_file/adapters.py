...
from metamart_schemas.v1.metadata.edges import EdgeMetadataTypeLabels, TableToColumnMetadata
...
from metamart_source_flat_file.models import ID, Column, Edge, Table
from metamart_source_flat_file.package_definitions import config
...
@build_metamart_metadata.register
def build_metamart_metadata_from_edge(current: Edge, version: Literal["v1"] = "v1") -> TableToColumnMetadata:
    """
