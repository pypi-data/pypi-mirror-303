...
class GreenscreenAreaDetails:
    ...
    **frames**
    ...
    def __init__(self, rgb_color: Tuple[int, int, int] = (0, 0, 255), similar_greens = [], upper_left_pixel: Tuple[int, int] = (0, 0), lower_right_pixel: Tuple[int, int] = (0, 0), frames: Union[Tuple[int, int], None] = None):
        ...
        self.region = Region(self.upper_left_pixel[0], self.upper_left_pixel[1], self.lower_right_pixel[0], self.lower_right_pixel[1])
