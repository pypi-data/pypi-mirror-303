...
_OptionSelection = _lit["frozen", "final", "abstract"] # 0.3.27rc2
...
class _InternalHelper:
    ...
    def __new__(cls, t: type[_T], o: _OptionSelection, /):
        ...
        def _no_sa(self: _T, name: str, value): # no setattr
            ...
            self.__class__ = _ref # ensurance reasons
        ...
        def _no_sub(): # no subclass
            _E(113, t.__name__)
            
        def _no_csub(cls: type): # no check subclass
            _E(116, t.__name__)
            
        def _empty_mro(self: _T):
            return None
...
class AbstractFrozen(pt.Enum):
    ...
    """
    __slots__ = ()
    from ._primal_types import override
    
    @override
    def __call__(self, *args, **kwds):
        _E(107, type(self).__name__)
    ...
    def __init_subclass__(cls):
        ...
        def _no_new(cls: type[pt.Self]):
            _E(104, cls.__name__)
            
        def _no_call(self: pt.Self, *args, **kwds):
            _E(107, cls.__name__)
