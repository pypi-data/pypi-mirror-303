...
class PublisherTermDynamicApi(BaseApi):
    ...
    def create_dynamic_term(self, aid: str, rid: str, name: str, currency: str, description: str = None, allow_start_in_future: bool = None, maximum_days_in_advance: int = None, body: CreateBillingConfigurationRequest = None) -> ApiResponse[Term]:
    ...
    def update_dynamic_term(self, aid: str, term_pub_id: str, rid: str = None, name: str = None, currency: str = None, description: str = None, payment_new_customers_only: bool = None, payment_allow_promo_codes: bool = None, show_full_billing_plan: bool = None, allow_start_in_future: bool = None, maximum_days_in_advance: int = None, collect_address: bool = None, delivery_zone: List[str] = None, default_country: str = None, body: UpdateBillingConfigurationRequest = None) -> ApiResponse[Term]:
