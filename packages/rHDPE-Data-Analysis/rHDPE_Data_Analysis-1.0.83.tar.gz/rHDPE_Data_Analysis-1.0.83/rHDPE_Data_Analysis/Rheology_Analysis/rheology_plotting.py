...
def plot_van_Gurp_Palmen_plot( ip, resin_data, file_data, data, splits, sample_array, samples_present_array, samples_to_plot, specimens, mean, colours, data_extraction_bool, savefig ):
    ...
    if mean:
        ...
        for i in samples_to_plot:
            ...
            shiny_de.append( (data[8][index][xaxis_mask] * 180 / np.pi).tolist() )
...
def plot_data( ip, file_data, data, first_derivative_data, second_derivative_data, savefig = False ):
    ...
    if perform_van_Gurp_Palmen_plot:
        ...
        plot_van_Gurp_Palmen_plot( ip, resin_data, file_data, data, splits, sample_array, samples_present_array, samples_to_plot, specimens, mean, colours, data_extraction_bool, savefig )
                        ...
                        if deriv0:
                            ...
                            if x == 0:
                                ...
                                if y == 8:
                                    ...
                                    data[y][index] = np.arctan( data[y][index] )
                                ...
                                if x == 8:
                                    ...
                                    data[x][index] = np.arctan( data[x][index] )
