...
class V1Meta(BaseModel):
    ...
    """ # noqa: E501
    uid: Optional[StrictStr] = Field(default=None, description="UID of the resource of the format <resource prefix>-<uuid>.")
    ...
    __properties: ClassVar[List[str]] = ["uid", "name", "description", "resourceVersion", "createTime", "updateTime", "labels", "annotations", "parentReference", "resourceNames"]
