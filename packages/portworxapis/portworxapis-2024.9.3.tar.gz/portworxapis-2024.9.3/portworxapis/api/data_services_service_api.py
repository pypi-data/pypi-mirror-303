...
class DataServicesServiceApi:
    ...
    @validate_call
    def data_services_service_get_data_service(
        self,
        id: Annotated[StrictStr, Field(description="UID of the Data Service.")],
        ...
        :param id: UID of the Data Service. (required)
        :type id: str
        ...
        _param = self._data_services_service_get_data_service_serialize(
            id=id,
    ...
    @validate_call
    def data_services_service_get_data_service_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="UID of the Data Service.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def data_services_service_get_data_service_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="UID of the Data Service.")],
        _request_timeout: Union[
            None,
    ...
    def _data_services_service_get_data_service_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/pds/v1/catalog/dataServices/{id}',
    ...
    @validate_call
    def data_services_service_list_data_services(
        self,
        enabled: Annotated[Optional[StrictStr], Field(description="Filter data services based on enabled flag.   - ENABLED_UNSPECIFIED: List all data services.  - TRUE: List only enabled data services.  - FALSE: List only disabled data services.")] = None,
        ...
        :param enabled: Filter data services based on enabled flag.   - ENABLED_UNSPECIFIED: List all data services.  - TRUE: List only enabled data services.  - FALSE: List only disabled data services.
        :type enabled: str
        ...
        _param = self._data_services_service_list_data_services_serialize(
            enabled=enabled,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "V1ListDataServicesResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def data_services_service_list_data_services_with_http_info(
        self,
        enabled: Annotated[Optional[StrictStr], Field(description="Filter data services based on enabled flag.   - ENABLED_UNSPECIFIED: List all data services.  - TRUE: List only enabled data services.  - FALSE: List only disabled data services.")] = None,
        sort_sort_by: Annotated[Optional[StrictStr], Field(description="Name of the attribute to sort results by.   - FIELD_UNSPECIFIED: Unspecified, do not use.  - NAME: Sorting based on the name of the resource.  - CREATED_AT: Sorting on create time of the resource.  - UPDATED_AT: Sorting on update time of the resource.  - PHASE: Sorting on phase of the resource.")] = None,
        sort_sort_order: Annotated[Optional[StrictStr], Field(description="Order of sorting to be applied on requested list. If sort_by having some value and sort_order is not provided, by default ascending order will be used to sort the list.   - VALUE_UNSPECIFIED: Unspecified, do not use.  - ASC: Sort order ascending.  - DESC: Sort order descending.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[V1ListDataServicesResponse]:
        """ListDataServices API lists the the data service resources.
    ...
    @validate_call
    def data_services_service_list_data_services_without_preload_content(
        self,
        enabled: Annotated[Optional[StrictStr], Field(description="Filter data services based on enabled flag.   - ENABLED_UNSPECIFIED: List all data services.  - TRUE: List only enabled data services.  - FALSE: List only disabled data services.")] = None,
        sort_sort_by: Annotated[Optional[StrictStr], Field(description="Name of the attribute to sort results by.   - FIELD_UNSPECIFIED: Unspecified, do not use.  - NAME: Sorting based on the name of the resource.  - CREATED_AT: Sorting on create time of the resource.  - UPDATED_AT: Sorting on update time of the resource.  - PHASE: Sorting on phase of the resource.")] = None,
        sort_sort_order: Annotated[Optional[StrictStr], Field(description="Order of sorting to be applied on requested list. If sort_by having some value and sort_order is not provided, by default ascending order will be used to sort the list.   - VALUE_UNSPECIFIED: Unspecified, do not use.  - ASC: Sort order ascending.  - DESC: Sort order descending.")] = None,
    ...
    def _data_services_service_list_data_services_serialize(
        self,
        enabled,
        sort_sort_by,
        sort_sort_order,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/pds/v1/catalog/dataServices',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
