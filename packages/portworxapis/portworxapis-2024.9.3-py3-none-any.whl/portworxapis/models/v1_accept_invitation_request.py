...
class V1AcceptInvitationRequest(BaseModel):
    ...
    """ # noqa: E501
    account_id: StrictStr = Field(description="we need to pass account_id in the body as for first time acceptance of request, user would not have the context of account.", alias="accountId")
