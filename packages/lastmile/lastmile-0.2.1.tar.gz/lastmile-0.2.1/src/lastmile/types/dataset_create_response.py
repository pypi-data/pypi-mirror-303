...
__all__ = ["DatasetCreateResponse", "Dataset", "DatasetID", "DatasetColumn", "DatasetColumnID", "DatasetOwnerUserID"]
...
class Dataset(BaseModel):
    ...
    labeling_status: Optional[str] = FieldInfo(alias="labelingStatus", default=None)
