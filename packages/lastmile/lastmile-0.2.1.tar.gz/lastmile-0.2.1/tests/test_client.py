...
class TestLastmile:
    ...
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.post("/api/2/auto_eval/model/get").mock(side_effect=httpx.TimeoutException("Test timeout error"))

        with pytest.raises(APITimeoutError):
            self.client.post(
                "/api/2/auto_eval/model/get",
                body=cast(object, dict(model_id={"value": "value"})),
    ...
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.post("/api/2/auto_eval/model/get").mock(return_value=httpx.Response(500))
    ...
    def test_retries_taken(
        ...
        respx_mock.post("/api/2/auto_eval/model/get").mock(side_effect=retry_handler)

        response = client.models.with_raw_response.retrieve(model_id={"value": "value"})
    ...
    def test_omit_retry_count_header(
        ...
        response = client.models.with_raw_response.retrieve(
            model_id={"value": "value"}, extra_headers={"x-stainless-retry-count": Omit()}
        )
    ...
    def test_overwrite_retry_count_header(
        ...
        response = client.models.with_raw_response.retrieve(
            model_id={"value": "value"}, extra_headers={"x-stainless-retry-count": "42"}
        )
...
class TestAsyncLastmile:
    ...
    async def test_retries_taken(
        ...
        response = await client.models.with_raw_response.retrieve(model_id={"value": "value"})
