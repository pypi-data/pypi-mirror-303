...
class TestDatasets:
    ...
    @parametrize
    def test_method_finalize_single_file_upload(self, client: Lastmile) -> None:
        dataset = client.datasets.finalize_single_file_upload(
        ...
        assert_matches_type(DatasetFinalizeSingleFileUploadResponse, dataset, path=["response"])

    @parametrize
    def test_raw_response_finalize_single_file_upload(self, client: Lastmile) -> None:
        response = client.datasets.with_raw_response.finalize_single_file_upload(
            dataset_id={"value": "value"},
            s3_presigned_post={
                "fields": [
                    {
    ...
    @parametrize
    def test_streaming_response_finalize_single_file_upload(self, client: Lastmile) -> None:
        with client.datasets.with_streaming_response.finalize_single_file_upload(
            dataset_id={"value": "value"},
            s3_presigned_post={
                "fields": [
                    {
...
class TestAsyncDatasets:
    ...
    @parametrize
    async def test_method_finalize_single_file_upload(self, async_client: AsyncLastmile) -> None:
        dataset = await async_client.datasets.finalize_single_file_upload(
            dataset_id={"value": "value"},
            s3_presigned_post={
                "fields": [
                    {
    ...
    @parametrize
    async def test_raw_response_finalize_single_file_upload(self, async_client: AsyncLastmile) -> None:
        response = await async_client.datasets.with_raw_response.finalize_single_file_upload(
            dataset_id={"value": "value"},
            s3_presigned_post={
                "fields": [
                    {
    ...
    @parametrize
    async def test_streaming_response_finalize_single_file_upload(self, async_client: AsyncLastmile) -> None:
        async with async_client.datasets.with_streaming_response.finalize_single_file_upload(
            dataset_id={"value": "value"},
            s3_presigned_post={
                "fields": [
                    {
