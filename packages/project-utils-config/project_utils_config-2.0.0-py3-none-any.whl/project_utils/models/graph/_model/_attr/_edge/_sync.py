...
class GraphAttrEdgeCollectionSyncModel(_BaseGraphAttrEdgeCollection):
    CHILD_CLASS = _GraphAttrEdge
    __context__: _GraphAttrEdgeCollectionSyncContext

    def __init__(self):
        super().__init__()
        self.__context__ = _GraphAttrEdgeCollectionSyncContext()
