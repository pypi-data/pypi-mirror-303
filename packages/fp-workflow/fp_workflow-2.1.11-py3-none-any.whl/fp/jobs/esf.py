...
write_eph_h5.py ./tmp struct {self.input.xctphbgw.num_epw_qpts} {self.input.xctphbgw.num_epw_cond_bands} {self.input.xctphbgw.num_epw_val_bands} {self.input.scf.num_val_bands} --switch_nu_and_cart
