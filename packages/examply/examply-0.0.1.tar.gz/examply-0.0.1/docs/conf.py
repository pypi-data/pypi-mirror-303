...
copyright = "2024"
_repo_root_url = "https://git.ligo.org/james.kennington/examply"
...
def linkcode_resolve(domain, info) -> str:
    ...
    fn = os.path.relpath(fn, start=os.path.dirname(__import__("examply").__file__))
    ...
    return f"{_repo_root_url}/-/blob/main/src/examply/{fn}{lineno}"
