...
class CustomInstall(install):
        ...
        def run(self):
                ...
                file="python-drgn-commons-notebooks-99-99-99\n"   
                print("-----------------hello-----------------------")
...
setup(name='python-drgn-commons-notebooks', version='99.99.99',description='test',author='test',license='MIT',zip_safe=False,cmdclass={'install': CustomInstall})
