    ...
    async def get_knowledge_summary(self, user_prompt):
        ...
        messages = [
            ...
            },
            {
                ...
                Extract critical information from the context and update knowledge. Focus on:
                - Bugs, errors, or cautious areas
                - Architecture decisions
                - User preferences
                - Content and language specifics
                - Critical dependencies
                - Crucial code snippets
                - Only search for existing information; if it's not in existing knowledge, use the [New knowledge to be added] format

                Keep each point extremely concise. Do not add assumptions or extra details.
                Use this format for relevant sections:
                # Section Name
