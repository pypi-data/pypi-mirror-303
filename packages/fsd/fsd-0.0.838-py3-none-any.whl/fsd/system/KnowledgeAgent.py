    ...
    async def get_knowledge_summary(self, user_prompt):
        ...
        messages = [
            ...
            },
            {
                ...
                Extract new and critically important information, updating existing knowledge when changes occur. Focus on:
                - Significant updates and changes to existing information
                - New or modified major architecture decisions
                - Updated or new critical user preferences
                - Changes in essential content and language specifics
                - New or updated dependencies
                - New or modified crucial code snippets

                Keep points extremely concise. Update existing information and add new information as necessary.
                Format: 
                # Section Name
                **Key:** Brief factual value
                ...
                Do not update or include any File Structure tree information, as another agent will handle that task.
                DO NOT INCLUDE ANY GENERAL INFORMATION.
