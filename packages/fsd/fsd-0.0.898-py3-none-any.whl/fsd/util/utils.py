...
def log_error(error_message: str, value: str) -> Dict:
    """
    Log an error by calling the error API with the provided error message and value.

    Args:
        error_message (str): The error message to send.
        value (str): The value associated with the error.
    ...
    try:
        ...
        logger.error(f"Error calling error API: {str(e)}")
        return {"error": str(e)}
