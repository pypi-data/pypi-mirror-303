...
class ContextPrepareAgent:
    ...
    async def get_file_planning(self, idea, file_attachments, focused_files, assets_link):
        ...
        prompt = (
            ...
            "ALWAYS INCLUDE our current dependency files (e.g., package.json, requirements.txt, Gemfile, pom.xml, build.gradle) as support so other people know what dependencies we are using. Include only our project's dependency files, not third-party ones. "
