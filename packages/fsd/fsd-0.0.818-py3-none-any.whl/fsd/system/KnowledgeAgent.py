    ...
    async def get_knowledge_summary(self, user_prompt):
        ...
        messages = [
            ...
            },
            {
                ...
                Using the existing 13 provided sections, update only the content within these sections. Do not add, remove, or modify the section headings themselves. Ensure all new information is placed within the appropriate existing section.
                Analyze:
                {user_prompt}
