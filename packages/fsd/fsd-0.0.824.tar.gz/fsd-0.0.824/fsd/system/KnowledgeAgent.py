    ...
    async def get_knowledge_summary(self, user_prompt):
        ...
        messages = [
            ...
            },
            {
                ...
                Extract key information from the context and update knowledge. Keep each key short and concise. Do not add assumptions or extra details.
                Do not modify section headings or add new sections.
