...
class CodingAgent:
    ...
    def get_current_time_formatted(self):
        ...
        try:
            ...
            error_message = f"Error in get_current_time_formatted: {str(e)}"
    ...
    def initial_setup(self, context_files, instructions, context, crawl_logs, file_attachments, assets_link):
        ...
        try:
            ...
            error_message = f"Error in initial_setup: {str(e)}"
            logger.error(error_message)
            call_error_api(error_message, str(e))
            ...
            if content.endswith(">>>>>>> REPLACE"):
                ...
                if continuation_content.endswith(">>>>>>> REPLACE"):
                    ...
                    if continuation_content1.endswith(">>>>>>> REPLACE"):
                        ...
                        if continuation_content2.endswith(">>>>>>> REPLACE"):
                            # Combine the incomplete and continuation responses
                            ...
                            error_message = "The `CodingAgent` encountered an error while getting coding request"
                            logger.error(error_message)
                            call_error_api(error_message, "Response does not end with >>>>>>> REPLACE")
                            return None

        except Exception as e:
            error_message = f"The `CodingAgent` encountered an error while getting coding request: {str(e)}"
            logger.error(error_message)
            call_error_api(error_message, str(e))
            raise
    ...
    def clear_conversation_history(self):
        ...
        try:
            ...
            error_message = f"Error in clear_conversation_history: {str(e)}"
            logger.error(error_message)
            call_error_api(error_message, str(e))
    ...
    def destroy(self):
        ...
        try:
            ...
            error_message = f"Error in destroy: {str(e)}"
            logger.error(error_message)
            call_error_api(error_message, str(e))
