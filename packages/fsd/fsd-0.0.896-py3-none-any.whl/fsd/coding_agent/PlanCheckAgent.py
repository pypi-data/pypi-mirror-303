...
class PlanCheckAgent:
    ...
    async def get_idea_check_plan(self, user_prompt):
        ...
        try:
            ...
            call_error_api("JSON decoding error", str(e))
            ...
            call_error_api("Error during process", str(e))
            return {
                "reason": str(e)
            }
    ...
    async def get_idea_check_plans(self, user_prompt):
        ...
        try:
            ...
            logger.error(f" #### The `DependencyCheckAgent` encountered an error while retrieving dependency check plans: `{e}`")
            call_error_api("Error retrieving dependency check plans", str(e))
            return {
                "reason": str(e)
            }
