...
class CrawlerAgent:
        ...
        for _ in range(len(self.api_keys)):
            try:
                ...
                if not crawl_id:
                    ...
                    call_error_api("Failed to initiate crawl", "No crawl ID was returned")
                ...
                while True:
                    ...
                    if status.get('status') == 'completed':
                        ...
                        call_error_api("Crawl failed", f"Status: {status.get('status')}")
                ...
                if results:
                    ...
                    call_error_api("No results retrieved", "Empty results")
    ...
    def process(self, website_url):
        ...
        if results is None:
            ...
            call_error_api("Crawling process failed", "Results are None")
            return None
