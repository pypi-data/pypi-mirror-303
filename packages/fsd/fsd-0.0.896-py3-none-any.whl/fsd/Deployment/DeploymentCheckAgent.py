...
class DeploymentCheckAgent:
    ...
    async def get_deployment_check_plan(self):
        ...
        try:
            ...
            error_message = f" #### The `DeploymentCheckAgent` encountered an error during the process: `{e}`"
    ...
    async def get_deployment_check_plans(self):
        ...
        try:
            ...
            error_message = "\n #### The `DeploymentCheckAgent` encountered an error while retrieving deployment check plans"
            logger.error(error_message)
            call_error_api(error_message, str(e))
            return {
                "reason": str(e)
