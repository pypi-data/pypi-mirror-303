        ...
        try:
            ...
            if result in ["0", 0]:
                ...
                if path != "null":
                    ...
                    self.repo.deploy_to_server(path, "zinley.site", name_subdomain)
                    ...
                    call_error_api("Unable to deploy. Invalid path.", "get_started_deploy_pipeline")
        except Exception as e:
            error_message = f"Error in deployment process: {str(e)}"
            logger.error(error_message)
            call_error_api(error_message, "get_started_deploy_pipeline")