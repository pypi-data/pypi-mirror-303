        ...
        try:
            ...
            while True:
                ...
                if stderr_line:
                    ...
                    call_error_api(stderr_line.strip(), "stderr")
                ...
                if process.poll() is not None:
                    ...
                    for line in process.stderr:
                        logger.info(line.strip())
                        output.append(line.strip())
                        call_error_api(line.strip(), "stderr")
                    break
            ...
            call_error_api(str(e), "exception")
        ...
        while retries < max_retries:
            ...
            try:
                ...
                if http_error.response.status_code == 429:
                    ...
                    call_error_api(str(http_error), "exception")
                    raise
            except Exception as e:
    ...
    async def execute_steps(self, steps_json, compile_files, code_files, original_prompt_language):
        ...
        for step in steps:
            ...
            while retry_count < self.max_retry_attempts:
                if step['method'] == 'bash':
                    ...
                    if return_code != 0:
                        ...
                        call_error_api(error_message, "command_error")
                        ...
                        if "Did you mean" in error_message:
                            ...
                            if user_select == 'a':
                                ...
                                if return_code == 0:
                                    ...
                                    call_error_api(error_message, "suggested_command_error")
                    ...
                    call_error_api(f"Unknown method: {step['method']}", "unknown_method")
                    break
            ...
            if retry_count == self.max_retry_attempts:
                ...
                call_error_api(error_message, "max_retries_reached")
                fixing_steps = await self.get_error_planner_requests(
                    error_message, step['prompt'], self.detector, compile_files, original_prompt_language)
