...
class KnowledgeAgent:
    ...
    async def get_knowledge_summary(self, user_prompt):
        ...
        messages = [
            ...
            {
                "role": "user",
                "content": f"Current file context: {current_summary}. Provide a concise, focused summary of the key points as short as possible to remember, learn and serve human better: ---- \n{user_prompt}"
            }
        ]
