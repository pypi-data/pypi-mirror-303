...
class MainExplainerAgent:
    ...
    def read_all_file_content(self, all_path):
        ...
        for path in all_path:
            try:
                ...
                call_error_api(error_message, path)
    ...
    async def get_answer_plan(self, conversation_history, user_prompt, language, all_file_content, role, file_attachments, focused_files, assets_link, crawl_logs):
        ...
        try:
            ...
            if file_attachments:
                for file_path in file_attachments:
                    try:
                        ...
                        error_message = f"Error reading attachment file content: {str(e)}"
                        call_error_api(error_message, file_path)
            ...
            if focused_files:
                for file_path in focused_files:
                    try:
                        ...
                        error_message = f"Error reading focused file content: {str(e)}"
                        call_error_api(error_message, file_path)
            ...
            try:
                ...
                error_message = f"Error in explainer_stream_prompt: {str(e)}"
                call_error_api(error_message, "explainer_stream_prompt")
            ...
            error_message = f"Error in get_answer_plan: {str(e)}"
            call_error_api(error_message, "get_answer_plan")
            return conversation_history
    ...
    async def get_answer_plans(self, conversation_history, user_prompt, language, files, role, file_attachments, focused_files, assets_link, crawl_logs):
        try:
            ...
            error_message = f"Error in get_answer_plans: {str(e)}"
            call_error_api(error_message, "get_answer_plans")
            return conversation_history
