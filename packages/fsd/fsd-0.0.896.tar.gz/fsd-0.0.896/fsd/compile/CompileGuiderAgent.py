...
class CompileGuiderAgent:
    ...
    async def get_guider_plan(self, user_prompt):
        ...
        try:
            ...
            error_message = f"CompileGuiderAgent encountered an error while generating the guider plan: {e}"
    ...
    async def get_guider_plans(self, user_prompt):
        ...
        try:
            ...
            error_message = f"CompileGuiderAgent encountered an error while retrieving guider plans: {e}"
            logger.error(error_message)
            call_error_api(error_message, str(e))
            return {
                "reason": str(e)
