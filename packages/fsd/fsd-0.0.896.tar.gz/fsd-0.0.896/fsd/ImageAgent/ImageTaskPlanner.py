...
class ImageTaskPlanner:
    ...
    async def get_task_plan(self, instruction):
        ...
        try:
            ...
            call_error_api("JSON decoding error in ImageTaskPlanner", str(e))
            ...
            call_error_api("Error in ImageTaskPlanner while generating task plan", str(e))
            return {"reason": str(e)}
    ...
    async def get_task_plans(self, instruction):
        ...
        try:
            ...
            logger.error(f" #### Error in get_task_plans: {e}")
            call_error_api("Error in ImageTaskPlanner get_task_plans", str(e))
            return {"reason": str(e)}
