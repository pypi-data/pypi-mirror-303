...
class ImageCheckAgent:
    ...
    async def get_image_check_plan(self, user_prompt):
        ...
        try:
            ...
            call_error_api(f"Error in get_image_check_plan: {str(e)}", str(e))
            return {
                "reason": str(e)
            }
    ...
    async def get_image_check_plans(self, user_prompt):
        ...
        try:
            ...
            logger.error(f" #### The `ImageCheckAgent` encountered an error during get_image_check_plans: `{e}`")
            call_error_api(f"Error in get_image_check_plans: {str(e)}", str(e))
            return {
                "reason": str(e)
            }
