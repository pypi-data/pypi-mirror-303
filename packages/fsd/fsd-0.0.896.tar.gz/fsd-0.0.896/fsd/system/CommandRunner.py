...
from fsd.util.utils import read_file_content, call_error_api, parse_payload
    ...
    async def execute_steps(self, steps_json, compile_files, original_prompt_language):
        ...
        for step in steps:
            ...
            while retry_count < self.max_retry_attempts:
                if step['method'] == 'bash':
                    ...
                    if return_code != 0:
                        ...
                        call_error_api(error_message, "command_execution")
                        ...
                        if "Did you mean" in error_message:
                            ...
                            if user_select == 'a':
                                ...
                                if return_code == 0:
                                    ...
                                    call_error_api(error_message, "suggested_command_execution")
            ...
            if retry_count == self.max_retry_attempts:
                ...
                call_error_api(error_message, "max_retry_attempts")
                fixing_steps = await self.get_error_planner_requests(error_message, step['prompt'], self.detector, compile_files)
