...
class FileContentManager:
    ...
    async def read_file(file_path: str) -> str:
        ...
        if not os.path.exists(file_path):
            ...
            call_error_api("File does not exist", file_path)
            return ""
        ...
        try:
            ...
            call_error_api(f"Failed to read file: {str(e)}", file_path)
            return ""
    ...
    async def write_file(file_path: str, content: str):
        ...
        try:
            ...
            call_error_api(f"Error writing to file: {str(e)}", file_path)
    ...
    def parse_search_replace_blocks(response: str) -> List[Tuple[str, str]]:
        ...
        if not matches:
            ...
            call_error_api(error_message, response)
        ...
        for search, replace in blocks:
            if search:
                ...
                if new_content is None:
                    ...
                    call_error_api("Couldn't find a match for search block", file_path)
    ...
    async def process_coding_agent_response(cls, file_path: str, coding_agent_response: str):
        ...
        try:
            ...
            try:
                ...
                call_error_api(f"No valid SEARCH/REPLACE blocks found: {str(e)}", file_path)
                return
    ...
    async def handle_coding_agent_response(cls, file_path: str, coding_agent_response: str):
        ...
        try:
            ...
            call_error_api(f"Error processing coding agent response: {str(e)}", file_path)
