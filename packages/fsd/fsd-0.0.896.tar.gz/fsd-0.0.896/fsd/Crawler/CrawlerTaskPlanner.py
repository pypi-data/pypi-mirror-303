...
class CrawlerTaskPlanner:
    ...
    async def get_crawl_plan(self, prompt):
        ...
        try:
            ...
            call_error_api(f"CrawlerTaskPlanner failed to get task plan", str(e))
            return {"reason": str(e)}
    ...
    async def get_crawl_plans(self, prompt):
        ...
        try:
            ...
            logger.error(f" #### The `CrawlerTaskPlanner` agent failed to retrieve crawl plans: {e}")
            call_error_api("CrawlerTaskPlanner failed to retrieve crawl plans", str(e))
            return {"reason": str(e)}
