...
class PromptImageUrlAgent:
    ...
    async def get_image_links(self, idea):
        ...
        try:
            ...
            call_error_api(f"PromptImageUrlAgent encountered an error: {str(e)}", str(e))
            return {
                "reason": str(e)
            }
    ...
    async def process_image_links(self, idea):
        ...
        try:
            ...
            logger.error(f" #### PromptImageUrlAgent encountered an error during process_image_links: `{e}`")
            call_error_api(f"PromptImageUrlAgent encountered an error during process_image_links: {str(e)}", str(e))
            return {
                "reason": str(e)
            }
