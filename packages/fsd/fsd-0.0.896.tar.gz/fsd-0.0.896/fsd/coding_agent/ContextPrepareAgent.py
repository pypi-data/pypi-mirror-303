...
class ContextPrepareAgent:
    ...
    async def get_file_planning(self, idea, file_attachments, focused_files, assets_link):
        ...
        try:
            ...
            call_error_api("Error processing image files", str(e))
        ...
        try:
            ...
            try:
                ...
                call_error_api("Failed to repair JSON", str(e))
                return {
                    "working_files": [],
                    "reason": str(e)
                }
            ...
            call_error_api("Context prepare agent error", str(e))
            return {
                "working_files": [],
                "reason": str(e)
            }
    ...
    async def get_file_plannings(self, idea, focused_files):
        ...
        try:
            ...
            logger.error(f"Error in get_file_plannings: {str(e)}")
