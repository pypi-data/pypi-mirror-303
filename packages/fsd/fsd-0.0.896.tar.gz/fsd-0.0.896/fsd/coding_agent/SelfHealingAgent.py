...
class SelfHealingAgent:
    ...
    def read_all_file_content(self, all_path):
        ...
        try:
            ...
            error_message = f"Error in read_all_file_content: {str(e)}"
            call_error_api(error_message, str(e))
            logger.error(error_message)
            return ""
    ...
    async def get_fixing_request(self, instruction, file_content, all_file_content, tech_stack):
        ...
        try:
            ...
            error_message = f"The `SelfHealingAgent` encountered an error during the fixing request: {str(e)}"
            call_error_api(error_message, str(e))
            logger.error(error_message)
            return {
                "reason": str(e)
    ...
    async def get_fixing_requests(self, instructions):
        ...
        try:
            ...
            error_message = f"Error in get_fixing_requests: {str(e)}"
            call_error_api(error_message, str(e))
            logger.error(error_message)
    ...
    async def replace_all_code_in_file(self, file_path, result):
        ...
        try:
            ...
            error_message = f"Error in replace_all_code_in_file: {str(e)}"
            call_error_api(error_message, str(e))
            logger.error(error_message)
