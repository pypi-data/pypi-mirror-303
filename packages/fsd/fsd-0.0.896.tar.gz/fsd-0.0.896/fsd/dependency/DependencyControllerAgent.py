...
class DependencyControllerAgent:
    ...
    async def guider_pipeline(self, user_prompt):
        ...
        while True:
            try:
                ...
                error_message = f"Error in guider_pipeline: {str(e)}"
                call_error_api(error_message, "guider_pipeline")
                logger.error(error_message)
                raise
    ...
    async def start_dependency_installation_process(self, instruction, original_prompt_language, file_attachments, focused_files):
        ...
        try:
            ...
            error_message = f"Error in start_dependency_installation_process: {str(e)}"
            call_error_api(error_message, "start_dependency_installation_process")
            logger.error(error_message)
            raise
    ...
    async def get_started(self, user_prompt, original_prompt_language, file_attachments, focused_files):
        ...
        try:
            ...
            call_error_api(error_message, "get_started")
            logger.error(error_message)
            raise
    ...
    async def get_started_coding_pipeline(self, user_prompt, original_prompt_language, file_attachments, focused_files):
        ...
        try:
            ...
            error_message = f"Error in get_started_coding_pipeline: {str(e)}"
            call_error_api(error_message, "get_started_coding_pipeline")
            logger.error(error_message)
            raise
