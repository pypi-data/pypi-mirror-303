...
class DependencyTaskPlanner:
    ...
    async def get_task_plan(self, instruction, os_architecture, original_prompt_language):
        ...
        try:
            ...
            call_error_api("Error retrieving task plan", str(e))
            return {"reason": str(e)}
    ...
    async def get_task_plans(self, instruction, original_prompt_language):
        ...
        try:
            ...
            logger.error(f" #### The `DependencyTaskPlanner` encountered an error while retrieving task plans:\n Error: {e}")
            call_error_api("Error retrieving task plans", str(e))
            return {"reason": str(e)}
