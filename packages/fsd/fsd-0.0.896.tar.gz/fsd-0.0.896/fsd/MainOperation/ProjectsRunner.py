    ...
    async def run_xcode_project(self, basename, role, file_attachments, focused_files, max_retries=25):
        ...
        while retries < max_retries:
            ...
            try:
                ...
                call_error_api("Xcode build error", bug_log_content)
                ...
                try:
                    ...
                    if http_error.response.status_code == 429:
                        ...
                        call_error_api("HTTP error during bug fixing", str(http_error))
                        raise
        ...
        if not bugFixed:
            ...
            call_error_api("Build failure after max retries", f"Max retries: {max_retries}")
            ...
            if "error:" in line.lower():
                ...
                if match:
                    ...
                    try:
                        ...
                        call_error_api("File not found error", f"File: {file_name}, Error: {error_message}")
                else:
                    ...
                    call_error_api("Unparseable error", line.strip())
