    ...
    async def get_knowledge_summary(self, user_prompt):
        ...
        messages = [
            ...
            },
            {
                ...
                Extract only new, critically important information not already in the knowledge context. Focus on:
                - Significant updates
                - Major architecture decisions
                - Critical user preferences
                - Essential content and language specifics
                - New dependencies
                - Crucial code snippets

                Keep points extremely concise. Only include what is absolutely necessary.
                Format: 
                # Section Name
