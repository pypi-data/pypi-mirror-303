...
class FileManagerAgent:
    ...
    async def get_file_planning(self, idea):
        ...
        try:
            ...
            error_message = f" #### The `FileManagerAgent` encountered an unexpected error: `{e}`"
    ...
    async def get_adding_file_planning(self, idea, tree, file_attachments):
        ...
        try:
            ...
            error_message = f" #### The `FileManagerAgent` encountered an unexpected error during adding file planning: `{e}`"
            logger.debug(error_message)
            log_error(error_message, str(e))
            return {
                "reason": str(e)
    ...
    async def get_moving_file_planning(self, idea, tree, file_attachments):
        ...
        try:
            ...
            error_message = f" #### The `FileManagerAgent` encountered an unexpected error during moving file planning: `{e}`"
            logger.debug(error_message)
            log_error(error_message, str(e))
            return {
                "reason": str(e)
