...
from metamart_schemas import config as base_config
...
from metamart_source_looker.models import (
    ID,
    Dashboard,
    Dimension,
    Edge,
...
from metamart_source_looker.package_definitions import config
...
def build_metamart_metadata_from_dashboard(current: Dashboard, version: Literal["v1"] = "v1") -> TableMetadata:
    """
...
@build_metamart_metadata.register
def build_metamart_metadata_from_query(current: Query, version: Literal["v1"] = "v1") -> ColumnMetadata:
    """
...
@build_metamart_metadata.register
def build_metamart_metadata_from_explore(current: Explore, version: Literal["v1"] = "v1") -> TableMetadata:
    """
...
@build_metamart_metadata.register
def build_metamart_metadata_from_dimension(current: Dimension, version: Literal["v1"] = "v1") -> ColumnMetadata:
    """
...
@build_metamart_metadata.register
def build_metamart_metadata_from_edge(current: Edge, version: Literal["v1"] = "v1") -> BaseEdgeMetadataV1:
    """
