...
class CommandManager:
	...
	def ExecuteFromCLI() -> None:
		...
		# lify
		parser = ArgumentParser(description = "lify")
		...
		# lify project
		projectParser : ArgumentParser = subparsers.add_parser("project", help = "Project related commands")
		...
		# lify project new
		newParser : ArgumentParser = projectSubparsers.add_parser("new", help = "Create a new project")
