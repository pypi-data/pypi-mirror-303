...
class MediaInsightsCompute19(TypedDict):
    v1: MediaInsightsComputeV1


class MediaInsightsCompute20(TypedDict):
...
MediaInsightsComputeOrUnknown = Optional[MediaInsightsCompute17]
