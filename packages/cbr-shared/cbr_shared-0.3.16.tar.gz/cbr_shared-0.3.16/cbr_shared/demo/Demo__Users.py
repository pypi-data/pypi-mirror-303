...
from osbot_utils.utils.Toml                 import toml_to_dict, toml_dict_from_file

FILE_NAME___DEMO_USERS__CONFIG_FILE = 'demo/demo_users.toml'
...
class Demo_Users(Type_Safe):
    ...
    def path_config_file(self):
        return path_combine(cbr_shared.path,FILE_NAME___DEMO_USERS__CONFIG_FILE)
