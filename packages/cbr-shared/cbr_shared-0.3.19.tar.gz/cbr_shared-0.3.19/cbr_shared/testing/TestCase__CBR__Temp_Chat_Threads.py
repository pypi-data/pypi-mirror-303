...
from tests.integration.cbr_shared__for_integration_tests                import cbr_shared__test_objects
...
class TestCase__CBR__Temp_Chat_Threads(TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.s3_db_server_requests = cbr_shared__test_objects.s3_db_server_requests()
        cls.s3_db_chat_threads    = cbr_shared__test_objects.s3_db_chat_threads   (reload_cache=True)
