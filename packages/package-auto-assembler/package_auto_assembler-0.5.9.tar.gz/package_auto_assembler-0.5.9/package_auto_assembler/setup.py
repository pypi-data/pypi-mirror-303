...
setup(
    ...
    install_requires=['mkdocs==1.6.0', 'fastapi', 'pyyaml', 'pip_audit==2.7.3', 'stdlib-list', 'attrs>=22.2.0', 'packaging', 'pandas==2.1.1', 'uvicorn', 'nbformat', 'numpy==1.26.0', 'requests', 'click==8.1.7', 'nbconvert==7.16.4'],
