...
class dsub:
    ...
    def _dsub_script(self):
        ...
        if self.output_file_name != "":
            ...
            phewas_output_env = f"--env PHEWAS_OUTPUT_FILE={self.output_folder}/{self.output_file_name}" + " "
        else:
        ...
        script = base_script + input_flags + output_flag + phewas_output_env + job_script
