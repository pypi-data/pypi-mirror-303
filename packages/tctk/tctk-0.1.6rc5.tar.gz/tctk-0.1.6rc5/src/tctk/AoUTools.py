...
class dsub:
    ...
    def __init__(
        ...
        if log_file is not None:
            ...
            self.log_file = f"${self.bucket}/dsub/logs/{{job-name}}/{{user-id}}/$(date +'%Y%m%d')/"
        ...
        print(
            ...
            "output_dict: " + str(self.output_files_dict) + "\n",
    ...
    def _dsub_script(self):
        ...
        output_flags = ""
        if len(self.output_files_dict) > 0:
            output_flags = ""
    ...
    def run(self):
        subprocess.call(self._dsub_script(), shell=True)
