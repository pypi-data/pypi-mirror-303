...
class FixtureRepository(MongoDBBaseRepository):
    ...
    def get_h2h_fixture(self, team1_id, team2_id, league_id, season):
        teams = [team1_id, team2_id]
        query = {'parameters.team': {'$in': teams}, 'parameters.league': league_id, 'parameters.season': season}
        fixture = self.find_documents('fixtures', query)
        logger.info(f'Fetching H2H fixture for team {team1_id} vs team {team2_id} for league {league_id} for season {season}')
        return fixture
