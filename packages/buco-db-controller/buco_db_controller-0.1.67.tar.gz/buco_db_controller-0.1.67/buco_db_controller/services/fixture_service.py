...
class FixtureService:
    ...
    def get_h2h_fixture(self, team1_id, team2_id, league_id, season) -> List[Fixture]:
        fixtures = self.fixture_repository.get_h2h_fixture(team1_id, team2_id, league_id, season)
        fixtures = [Fixture.from_dict(fixture) for fixture in fixtures]

        h2h_fixtures = fixtures.copy()
        for fixture in fixtures:
            if fixture.home_team.team_id not in [team1_id, team2_id] or fixture.away_team.team_id not in [team1_id, team2_id]:
