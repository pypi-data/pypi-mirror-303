...
class StreamBuffer:
    ...
    def __init__(self, audio_type: StreamAudioType, session: CreatedSession):
        ...
        self.window_byte_size = audio_type.get_window_byte_size(session.window_size)
        self.window_hop_byte_size = int(self.window_byte_size / session.window_size * session.window_hop.second)
