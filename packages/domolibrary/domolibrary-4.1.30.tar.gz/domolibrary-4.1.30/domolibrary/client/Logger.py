...
class TracebackDetails:
    ...
    traceback_stack: List[traceback.FrameSummary] = None
    ...
    def __init__(
        ...
        if isinstance(traceback_stack, list) and len(traceback_stack) > 0: 
            tslice = traceback_stack[-1]

            if isinstance(tslice, list):    
                self.function_name = tslice[2] 
                self.file_name = tslice[0]
