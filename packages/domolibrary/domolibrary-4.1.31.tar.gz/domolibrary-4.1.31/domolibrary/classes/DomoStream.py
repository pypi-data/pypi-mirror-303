...
# %% auto 0
__all__ = ['custom_query', 'StreamConfig_Mapping', 'StreamConfig_Mapping_amazon_s3_assumerole',
           'StreamConfig_Mapping_snowflake_unload_v2', 'StreamConfig_Mapping_snowflake_federated',
           'StreamConfig_Mapping_snowflake', 'StreamConfig', 'DomoStream']
...
class StreamConfig_Mapping_amazon_s3_assumerole(StreamConfig_Mapping):
    data_provider_type = 'amazon_s3_assumerole'
    sql = None
    s3_bucket_category = "filesDiscovery"


class StreamConfig_Mapping_snowflake_unload_v2(StreamConfig_Mapping):
...
class StreamConfig_Mapping_snowflake_federated(StreamConfig_Mapping):
    data_provider_type = 'snowflake_federated'
    sql = None
    warehouse = None
    database_name = None
    s3_bucket_category = None

class StreamConfig_Mapping_snowflake(StreamConfig_Mapping):
    data_provider_type = 'snowflake'
    sql = 'query'
    warehouse = 'warehouseName'
    database_name = 'databaseName'
    s3_bucket_category = None
# class StreamConfig_Mapping_Enum(Enum):

# %% ../../nbs/classes/50_DomoStream.ipynb 8
...
class StreamConfig:
    ...
    category: str = None # if this is the SQL node... then i know

    # problem .. how do i know that it contains sql?
...
class DomoStream:
    ...
    async def get_stream_by_id(
        ...
        for config in dd.configuration:
            ...
            if sc.name in custom_query: ## if sc.category == 'SQL'
