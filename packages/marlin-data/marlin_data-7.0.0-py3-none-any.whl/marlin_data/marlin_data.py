...
class MarlinDerivedData(object):
    ...
    def build_derived_data(self, simulation_data : SimulationData = None, sample_delta_t : float = 0.5, f_min : int = 0, f_max : int = 1000):
        ...
        number_energy_frames = len(energy_frames)
        number_freq_frames = len(self.librosa_f_bins)
        number_time_frames = len(self.librosa_time_bins)
        print (f' Number of energy frames -> {number_energy_frames}')
        print (f' Number of energy frames -> {number_freq_frames}') 
        print (f' Number of time frames -> {number_time_frames}')  
    ...
    def ft_query_energy_frame(self, _time : dt, freq : float):
        ...
        return (self.fourier[f_idx, t_idx])
