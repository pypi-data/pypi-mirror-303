...
<script context="module" lang="ts">
	...
	export { default as BaseSwitch } from "./shared/Toggle.svelte";
  </script>
  ...
  <script lang="ts">
	...
	// Reactive statements for computed properties
	$: ariaChecked = value;
	$: ariaLabel = show_label ? label : 'Toggle';
  
	$: toggleSwitchStyle = `
	  background-color: ${value ? color : 'var(--toggle-background-color)'};
	...
	// Toggle the value when the component is activated (Mouse or Keyboard)
...
<style>
	:root {
	  ...
	  --toggle-background-color: var(--border-color-primary);
