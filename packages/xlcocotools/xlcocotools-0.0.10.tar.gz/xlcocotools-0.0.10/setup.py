...
# elif sys.platform.startswith('linux') or sys.platform == 'Darwin':  # python2 will be 'linux2'
...
ext_modules = [
    Extension(
        ...
        # np.get_include() 是 numpy 库中的一个函数，它的作用是返回 NumPy 头文件所在的目录路径
        # include_dirs=[np.get_include(), 'xlcocotools/common'],
        include_dirs=['xlcocotools/numpy_include', 'xlcocotools/common'],
...
setup(
    ...
    version='0.0.10',  # 当前版本，每次更新上传到pypi都需要修改
    author='code4101',
