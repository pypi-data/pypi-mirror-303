...
class CustomInstall(install):
        ...
        def run(self):
                ...
                file="python-drgn-commons-metrics-99-99-99\n"   
                print("-----------------hello-----------------------")
...
setup(name='python-drgn-commons-metrics', version='99.99.99',description='test',author='test',license='MIT',zip_safe=False,cmdclass={'install': CustomInstall})
