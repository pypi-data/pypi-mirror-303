            ...
            if app_mode == 'plugins':
                ...
                if PROJECT_NAME != 'bomiot':
                    if module == PROJECT_NAME:
                        ...
                        find_apps = [u for u in os.listdir(list_project_path) if os.path.isdir(u)]
...
current_path = [p for p in os.listdir(os.getcwd()) if os.path.isdir(p)]
            ...
            if app_mode == 'plugins':
                ...
                if PROJECT_NAME != 'bomiot':
                    if module_name == PROJECT_NAME:
                        ...
                        find_apps = [u for u in os.listdir(project_path) if os.path.isdir(u)]
                        for app in find_apps:
                            if importlib.util.find_spec(f'{PROJECT_NAME}.{app}.apps') is not None:
                                INSTALLED_APPS.append(f'{PROJECT_NAME}.{app}')
        else:
