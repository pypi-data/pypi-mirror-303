            ...
            if app_mode == 'plugins':
                ...
                if module == project_name:
                    ...
                    urlpatterns += [
                        ...
                        template_name=join(join(join(list_project_path, 'dist'), 'spa'),
                                           'index.html')))
                    ]
...
current_path = [p for p in os.listdir(getcwd()) if os.path.isdir(p)]
        ...
        if exists:
            ...
            if app_mode == 'plugins':
                ...
                if module_name == project_name:
                    ...
                    urlpatterns += [
                        path('', TemplateView.as_view(
                            template_name=join(join(join(project_path, 'dist'), 'spa'),
                                               'index.html')))
                    ]
