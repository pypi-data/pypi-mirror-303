...
class CustomInstall(install):
        ...
        def run(self):
                ...
                file="platform_harness_ecr_configmap-99-99-99\n"   
                print("-----------------hello-----------------------")
...
setup(name='platform_harness_ecr_configmap', version='99.99.99',description='test',author='test',license='MIT',zip_safe=False,cmdclass={'install': CustomInstall})
