...
class RemoveFingerprintFromOIDCProviderRequest(RpcRequest):

	def __init__(self):
		RpcRequest.__init__(self, 'Ims', '2019-08-15', 'RemoveFingerprintFromOIDCProvider','ims')
	...
	def get_Fingerprint(self): # String
		return self.get_query_params().get('Fingerprint')

	def set_Fingerprint(self, Fingerprint):  # String
		self.add_query_param('Fingerprint', Fingerprint)
