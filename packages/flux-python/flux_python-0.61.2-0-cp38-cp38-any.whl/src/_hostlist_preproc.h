...
# 103 "/__w/flux-python/flux-python/src/_hostlist_clean.h"
const char * hostlist_first (struct hostlist *hl);
# 113 "/__w/flux-python/flux-python/src/_hostlist_clean.h"
const char * hostlist_last (struct hostlist *hl);
# 123 "/__w/flux-python/flux-python/src/_hostlist_clean.h"
