...
class SearchProductsGoogleResponseResponseBodyData(BaseModel):
    message: Optional[str] = None
    r"""Error message string"""


class SearchProductsGoogleResponseResponseBody(Exception):
    r"""SearchProducts API server error response"""

    data: SearchProductsGoogleResponseResponseBodyData

    def __init__(self, data: SearchProductsGoogleResponseResponseBodyData):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(
            self.data, SearchProductsGoogleResponseResponseBodyData
        )


class SearchProductsGoogleResponseBodyData(BaseModel):
    message: Optional[str] = None
    r"""Error message string"""


class SearchProductsGoogleResponseBody(Exception):
    r"""SearchProducts API user error response"""

    data: SearchProductsGoogleResponseBodyData

    def __init__(self, data: SearchProductsGoogleResponseBodyData):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, SearchProductsGoogleResponseBodyData)
