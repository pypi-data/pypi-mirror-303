...
class SearchPeopleLinkedinResponseResponseBodyData(BaseModel):
    message: Optional[str] = None
    r"""Error message string"""


class SearchPeopleLinkedinResponseResponseBody(Exception):
    r"""SearchPeople API server error response"""

    data: SearchPeopleLinkedinResponseResponseBodyData

    def __init__(self, data: SearchPeopleLinkedinResponseResponseBodyData):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(
            self.data, SearchPeopleLinkedinResponseResponseBodyData
        )


class SearchPeopleLinkedinResponseBodyData(BaseModel):
    message: Optional[str] = None
    r"""Error message string"""


class SearchPeopleLinkedinResponseBody(Exception):
    r"""SearchPeople API user error response"""

    data: SearchPeopleLinkedinResponseBodyData

    def __init__(self, data: SearchPeopleLinkedinResponseBodyData):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, SearchPeopleLinkedinResponseBodyData)
