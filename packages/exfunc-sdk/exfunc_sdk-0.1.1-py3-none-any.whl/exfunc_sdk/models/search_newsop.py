...
class SearchNewsGoogleResponseResponseBodyData(BaseModel):
    message: Optional[str] = None
    r"""Error message string"""


class SearchNewsGoogleResponseResponseBody(Exception):
    r"""SearchNews API server error response"""

    data: SearchNewsGoogleResponseResponseBodyData

    def __init__(self, data: SearchNewsGoogleResponseResponseBodyData):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, SearchNewsGoogleResponseResponseBodyData)


class SearchNewsGoogleResponseBodyData(BaseModel):
    message: Optional[str] = None
    r"""Error message string"""


class SearchNewsGoogleResponseBody(Exception):
    r"""SearchNews API user error response"""

    data: SearchNewsGoogleResponseBodyData

    def __init__(self, data: SearchNewsGoogleResponseBodyData):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, SearchNewsGoogleResponseBodyData)
