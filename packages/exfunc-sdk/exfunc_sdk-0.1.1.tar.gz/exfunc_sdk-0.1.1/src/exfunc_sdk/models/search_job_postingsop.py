...
class SearchJobPostingsLinkedinResponseResponseBodyData(BaseModel):
    message: Optional[str] = None
    r"""Error message string"""


class SearchJobPostingsLinkedinResponseResponseBody(Exception):
    r"""SearchJobPosting API server error response"""

    data: SearchJobPostingsLinkedinResponseResponseBodyData

    def __init__(self, data: SearchJobPostingsLinkedinResponseResponseBodyData):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(
            self.data, SearchJobPostingsLinkedinResponseResponseBodyData
        )


class SearchJobPostingsLinkedinResponseBodyData(BaseModel):
    message: Optional[str] = None
    r"""Error message string"""


class SearchJobPostingsLinkedinResponseBody(Exception):
    r"""SearchJobPosting API user error response"""

    data: SearchJobPostingsLinkedinResponseBodyData

    def __init__(self, data: SearchJobPostingsLinkedinResponseBodyData):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, SearchJobPostingsLinkedinResponseBodyData)
