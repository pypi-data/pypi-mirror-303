...
class SearchPropertiesZillowResponseResponseBodyData(BaseModel):
    message: Optional[str] = None
    r"""Error message string"""


class SearchPropertiesZillowResponseResponseBody(Exception):
    r"""Search API server error response"""

    data: SearchPropertiesZillowResponseResponseBodyData

    def __init__(self, data: SearchPropertiesZillowResponseResponseBodyData):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(
            self.data, SearchPropertiesZillowResponseResponseBodyData
        )


class SearchPropertiesZillowResponseBodyData(BaseModel):
    message: Optional[str] = None
    r"""Error message string"""


class SearchPropertiesZillowResponseBody(Exception):
    r"""Search API user error response"""

    data: SearchPropertiesZillowResponseBodyData

    def __init__(self, data: SearchPropertiesZillowResponseBodyData):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, SearchPropertiesZillowResponseBodyData)
