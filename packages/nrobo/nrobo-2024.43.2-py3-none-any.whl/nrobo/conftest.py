...
def pytest_runtest_makereport(item, call):
    ...
    if description:
        # Get first line of doc string
        description = re.findall(r"(.*)", description.strip())[0]
        report.description = description
        # _len = len(description)
        # max_chars_description = 200
        # report.description = description if _len <= max_chars_description else f"{description[0:max_chars_description]}..."
    # test_fn = item.obj
