...
def home(request):
    ...
    return render(request, 'shared_lib/test/_home.html', context)
...
def terms(request):
    ...
    return render(request, 'shared_lib/test/_test_terms.html', context)
...
def privacy(request):
    ...
    return render(request, 'shared_lib/test/_test_pricacy.html', context)
