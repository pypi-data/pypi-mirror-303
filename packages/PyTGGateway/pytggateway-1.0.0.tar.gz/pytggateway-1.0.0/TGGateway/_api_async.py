...
class AsyncTGGateway:
    ...
    async def _request(self, method: str, values: dict = None) ->  Union[RequestStatus, bool]:
        """
        ...
        response = await self.session.post(f'https://gatewayapi.telegram.org/{method}',
            json=values
        )
