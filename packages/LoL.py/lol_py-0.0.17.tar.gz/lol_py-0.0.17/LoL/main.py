...
class LoL():
    ...
    def __init__(self, api_key, region = 'na') -> None:
        ...
        self.__base_url_3 = f"https://{self.__v5_region}.api.riotgames.com/riot"
    ...
    def get_summoner(self, name:str =None, accountId =None, puuid =None, summonerid =None):
        ...
        if name:
            ...
            url = f"{self.__base_url_3}/account/v1/accounts/by-riot-id/{game_name}/{tag}{self.__url_key}"
        elif accountId:
    ...
    def get_champions_mastery_by_encryptedPUUID(self, encryptedPUUID:int):
        url = f"{self.__base_url_1}/champion-mastery/v4/champion-masteries/by-puuid/{encryptedPUUID}{self.__url_key}"
        
        return self.__get_information(url)
    
    def get_champion_mastery_by_encryptedPUUID_and_championId(self, encryptedPUUID:int, championId:int):
        url = f"{self.__base_url_1}/champion-mastery/v4/champion-masteries/by-puuid/{encryptedPUUID}/by-champion/{championId}{self.__url_key}"
        return self.__get_information(url)
    ...
    def get_live_match_by_encryptedPUUID(self, encryptedPUUID: int):
        url = f"{self.__base_url_1}/spectator/v5/active-games/by-summoner/{encryptedPUUID}{self.__url_key}"
        return self.__get_information(url)
