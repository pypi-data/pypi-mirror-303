from industrial_time_series_analysis.Forecast.forecast_continuous_learning.test import testtt
import numpy as np
from industrial_time_series_analysis.Forecast.forecast_continuous_learning.util import ewc_utils
