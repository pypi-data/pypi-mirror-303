...
from .log import log, verbose_log_check, cfg
# from .log import *
# from .certifier import CertifierError, certifier_create_info, gen_application_error_msg
from .constants import *
import json
import secrets
# import certifier
# from .certifier import certifier_create_info

from .error import CertifierError, gen_application_error_msg, certifier_create_info
# from .certifier import gen_application_error_msg, certifier_create_info

cfg_order_list = [DEFAULT_CFG_FILENAME, DEFAULT_USER_CFG_FILENAME, DEFAULT_GLOBAL_CFG_FILENAME] 
ca_path_order_list = [DEFAULT_CA_PATH, DEFAULT_USER_CA_PATH, DEFAULT_GLOBAL_CA_PATH, DEFAULT_CURDIR_CA_PATH]
ca_info_order_list = [DEFAULT_CA_INFO, DEFAULT_USER_CA_INFO, DEFAULT_GLOBAL_CA_INFO]
...
def property_set_defaults_from_cfg_file(prop_map: CertifierPropMap, verbose: bool):
    ...
    if ('libcertifier.input.p12.path' in data):
        verbose_log_check(verbose, "Loaded input_p12_path_value: " + str(data['libcertifier.input.p12.path']) + " from config file.", "INFO")
