...
CERTIFIER_REGISTRATION_STATUS_CERT_TIME_VALID = (1 << 7)
...
DEFAULT_CFG_FILENAME = "./libcertifier.cfg"
DEFAULT_USER_CFG_FILENAME = "/usr/local/etc/certifier/libcertifier.cfg"
DEFAULT_GLOBAL_CFG_FILENAME = "/etc/certifier/libcertifier.cfg"
DEFAULT_AUTH_TYPE = "X509"
DEFAULT_CA_INFO = "libcertifier-cert.crt"
DEFAULT_USER_CA_INFO = "/usr/local/etc/certfier/libcertifier-cert.crt"
DEFAULT_GLOBAL_CA_INFO = "/etc/ssl/certs/libcertifier-cert.crt"
