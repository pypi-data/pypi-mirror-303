...
def pivot_table(df, column1, column2, drop_na=True, save_to_file=True, output_file_name=None):
	...
	if output_file_name:
		count_custom_output_file_name = output_file_name + "_pivot_table_count"
		group_ratio_custom_output_file_name = output_file_name + "_pivot_table_group_ratio"
...
def threshold_selection(df, ground_truth_column, predict_column, need_sigmoid=True, threshold_list=None,  line_chart_metrics=None, save_to_file=True, output_file_name=None):
	...
	if output_file_name:
		optimum_thresholds_output_file_name = output_file_name + "_optimum_thresholds" 
