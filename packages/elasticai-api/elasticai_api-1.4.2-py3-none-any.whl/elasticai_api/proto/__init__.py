...
if package_version_bigger_than("protobuf", "3.20.3"):
    from .protobuf_4_25_3 import elasticai_api_pb2, elasticai_api_pb2_grpc
else:
    from .protobuf_3_20_3 import elasticai_api_pb2, elasticai_api_pb2_grpc


__all__ = ["elasticai_api_pb2", "elasticai_api_pb2_grpc"]
