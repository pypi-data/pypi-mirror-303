...
def _is_finalvar_with_default_val(type_: type[Any], val: Any) -> bool:
    ...
    return not (not is_finalvar(type_)
     or val is PydanticUndefined or
     isinstance(val, FieldInfo) and (val.default is PydanticUndefined and val.default_factory is None))
