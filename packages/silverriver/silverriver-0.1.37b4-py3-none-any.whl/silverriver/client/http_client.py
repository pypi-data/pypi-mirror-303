...
from silverriver.client.trace_endpoints import QAEndpoints
...
class HTTPCruxClient(httpx.Client):
    ...
    def env_setup(self, start_url: str) -> SetupOutput:
        setup_out = self._make_request(
            **BrowserEndpoints.SETUP.request_args(data=SetupInput(start_url=start_url)))
    ...
    def upload_logs(self, prefix: str, blob: bytes) -> bool:
        all_args = QAEndpoints.UPLOAD_TEST_LOGS.request_args(
