...
from utils.imageListLoading import img_lst_pos_maintainer_factory
...
image_list_position_maintainer = img_lst_pos_maintainer_factory["maintain_file_position"]
...
class MainWindow(QMainWindow, WindowMixin):
    ...
    def __init__(self, default_filename=None, default_prefdef_class_file=None, default_save_dir=None):
        ...
        rm_dir = action(get_str("delDir"), self.remove_active_dir, 'Alt+R', 'remove', get_str('delDir'))
        ...
        self.actions = Struct(save=save, save_format=save_format, saveAs=save_as, close=close, resetAll=reset_all,
                              ...
                              active_dirs_ops=(add_dir, rm_dir, reset_dirs),
    ...
    def move_image_to_active_dir(self):
        ...
        if not self.cur_img_idx or not self.m_img_list:
            return
    ...
    @image_list_position_maintainer
    ...
    def remove_selected_active_dir(self):
        ...
        if selected_items:
            ...
            self.remove_active_dir(directory, directory_text)

    def remove_active_dir(self, directory: Path, directory_text):
    ...
    def import_dir_images(self, dir_path):
        ...
        for imgPath in self.m_img_list:
            item_name = Path(imgPath).relative_to(self.com_img_path)
