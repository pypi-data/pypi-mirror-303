...
class MainWindow(QMainWindow, WindowMixin):
    ...
    def __init__(self, default_filename=None, default_prefdef_class_file=None, default_save_dir=None):
        ...
        add_dir = action(get_str("addDir"), self.add_active_dir,
                         'Alt+A', 'add', get_str("addDir"))
        reset_dirs = action(get_str("resetDirs"), self.reset_active_dirs,
                         'Alt+A+R', 'reset', get_str('resetDirs'))
        rm_dir = action(get_str("delDir"), self.remove_active_dir,
                         'Alt+R', 'remove', get_str('delDir'))
