...
from metamart_schemas.integrations.quarantine import (
...
class MetamartIntegrationImplementation(ABC):
    """Base class for Metamart integrations
    ...
    def __init__(
        ...
        """Initializes the Metamart integration.
...
class QuarantineAccessor:
    ...
    def __init__(self, integration_instance: MetamartIntegrationImplementation):
...
class ValidatedIntegration(MetamartIntegrationImplementation):
    ...
    def __init__(self, integration: MetamartIntegrationImplementation, *args, **kwargs):
