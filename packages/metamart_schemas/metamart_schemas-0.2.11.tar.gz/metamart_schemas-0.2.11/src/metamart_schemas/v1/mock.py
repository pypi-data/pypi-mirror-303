...
from metamart_schemas.generics import DefaultValue
from metamart_schemas.human_ids import get_human_id
from metamart_schemas.v1.edge import EdgeV1
from metamart_schemas.v1.edge import IDSourceSpec as EdgeIDSourceSpec
from metamart_schemas.v1.edge import IDSpec as EdgeIDSpec
from metamart_schemas.v1.edge import NamedSourceSpec as NamedEdgeSourceSpec
from metamart_schemas.v1.edge import NamedSpec as NamedEdgeSpec
from metamart_schemas.v1.edge import SourcedEdgeSpec, SourcedEdgeV1
from metamart_schemas.v1.events import EventSpec, EventV1
from metamart_schemas.v1.metadata import edges, nodes
from metamart_schemas.v1.metadata.metadata import (
    EdgeMetadataV1,
    MetamartEdgeMetadataV1,
    MetamartNodeMetadataV1,
    NodeMetadataV1,
    SourcesEdgeMetadataV1,
    SourcesNodeMetadataV1,
)
from metamart_schemas.v1.node import (
    IDSourceSpec,
    IDSpec,
    NamedSourceSpec,
    NamedSpec,
...
class MetamartNodeMetadataV1Factory(ModelFactory[MetamartNodeMetadataV1]):
    __model__ = MetamartNodeMetadataV1
    __set_as_default_factory_for_type__ = True


class MetamartEdgeMetadataV1Factory(ModelFactory[MetamartEdgeMetadataV1]):
    __model__ = MetamartEdgeMetadataV1
    __set_as_default_factory_for_type__ = True
...
class NamedNodeSpecFactory(ModelFactory[NamedSpec]):
    ...
    def metadata(cls, data_sources: List[SourceSpec]) -> NodeMetadataV1:
        """ """
        sources = {source.name: MetamartNodeMetadataV1Factory.build() for source in data_sources}
...
class NamedEdgeSpecFactory(ModelFactory[NamedEdgeSpec]):
    ...
    def metadata(cls, data_sources: List[SourceSpec]) -> EdgeMetadataV1:
        """ """
        sources = {source.name: MetamartEdgeMetadataV1Factory.build() for source in data_sources}
