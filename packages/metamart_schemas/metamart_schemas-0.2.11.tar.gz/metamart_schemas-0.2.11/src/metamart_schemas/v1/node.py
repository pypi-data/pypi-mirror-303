...
from metamart_schemas.v1.generics import ID, BaseID, NamedID, UuidID
from metamart_schemas.v1.metadata.metadata import (
    MetamartMetadataV1,
    MetamartNodeMetadataV1,
    MetadataV1,
    NodeMetadataV1,
)
from metamart_schemas.v1.metadata.nodes import GenericNodeMetadataV1
...
class BaseSourcedNodeSpec(MetamartBaseModel):
    ...
    metadata: MetamartNodeMetadataV1 = MetamartNodeMetadataV1(metamart=GenericNodeMetadataV1(node_type="Generic"))

    @validator("metadata", always=True, pre=True)
    def validate_metadata(cls, v: Optional[Union[Dict, MetamartNodeMetadataV1]]) -> MetamartNodeMetadataV1:
        if isinstance(v, MetamartNodeMetadataV1):
            return v
        elif isinstance(v, dict):
            v.setdefault("metamart", GenericNodeMetadataV1(node_type="Generic"))
            return MetamartNodeMetadataV1(**v)
        elif v is None:
            return MetamartNodeMetadataV1(metamart=GenericNodeMetadataV1(node_type="Generic"))
...
class NamedSourceSpec(NodeNamedID, BaseSourcedNodeSpec):
    ...
    def to_node(self) -> "NamedSpec":
        ...
        values["metadata"] = {"metamart": self.metadata.metamart, "sources": {self.data_source.name: self.metadata}}
...
class IDSourceSpec(NodeUuidID, BaseSourcedNodeSpec):
    ...
    def to_node(self) -> "IDSpec":
        ...
        values["metadata"] = {
            "metamart": values["metadata"]["metamart"],
...
class SourcedNodeV1(MetamartBaseModel):
...
class BaseNodeSpec(MetamartBaseModel):
    ...
    metadata: NodeMetadataV1 = NodeMetadataV1(metamart=GenericNodeMetadataV1(node_type="Generic"), sources={})
    ...
    def validate_metadata(cls, v: Optional[Union[Dict, NodeMetadataV1]]) -> NodeMetadataV1:
        if isinstance(v, NodeMetadataV1):
            ...
            return NodeMetadataV1(metamart=GenericNodeMetadataV1(node_type="Generic"), sources={})
        raise ValueError(f"Invalid metadata: {v}. Expected either None, a dict, or a MetadataV1 instance.")
...
class NodeV1(MetamartBaseModel):
