...
class ToTable(Node, NameableInputFields):
    ...
    def __init__(self, init_inputs: Node.InitSchema):
        self.columns = NameableInputFields(
    ...
    def InputSchema(self):
        return self.columns.InputSchema

    @property
    def tgt_handles(self):
        return self.columns.tgt_handles

    @tgt_handles.setter
    def tgt_handles(self, value):
        self.columns.tgt_handles = value

    def _set_schemas(self) -> None:
        self.columns.set_schemas()

    def forward(self, node_input):
        column_maps = {column._clean: column.free for column in self.columns.values}
